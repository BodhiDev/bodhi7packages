#ifndef EFL_UI_POPUP_EO_HH
#define EFL_UI_POPUP_EO_HH
#include <Eo.h>
...
#ifndef EFL_UI_POPUP_FWD_GUARD
#define EFL_UI_POPUP_FWD_GUARD
namespace efl { namespace ui { 
struct Popup;
} } 
namespace efl { namespace eo { template<> struct is_eolian_object< ::efl::ui::Popup> : ::std::true_type {}; } }
namespace efl { namespace eo { template<> struct is_eolian_object< ::efl::ui::Popup&> : ::std::true_type {}; } }
namespace efl { namespace eo { template<> struct is_eolian_object< ::efl::ui::Popup const> : ::std::true_type {}; } }
namespace efl { namespace eo { template<> struct is_eolian_object< ::efl::ui::Popup const&> : ::std::true_type {}; } }
#endif
...
namespace efl { namespace ui { 
struct Popup {
    ::efl::eolian::return_traits<Efl_Ui_Popup_Align>::type align_get() const;
    ::efl::eolian::return_traits<void>::type align_set( ::efl::eolian::in_traits<Efl_Ui_Popup_Align>::type type) const;
    ::efl::eolian::return_traits<double>::type closing_timeout_get() const;
    ::efl::eolian::return_traits<void>::type closing_timeout_set( ::efl::eolian::in_traits<double>::type time) const;
    ::efl::eolian::return_traits< ::efl::canvas::Object>::type anchor_get() const;
    ::efl::eolian::return_traits<void>::type anchor_set( ::efl::eolian::in_traits< ::efl::canvas::Object>::type anchor) const;
    ::efl::eolian::return_traits<void>::type align_priority_get( ::efl::eolian::out_traits<Efl_Ui_Popup_Align>::type first,  ::efl::eolian::out_traits<Efl_Ui_Popup_Align>::type second,  ::efl::eolian::out_traits<Efl_Ui_Popup_Align>::type third,  ::efl::eolian::out_traits<Efl_Ui_Popup_Align>::type fourth,  ::efl::eolian::out_traits<Efl_Ui_Popup_Align>::type fifth) const;
    ::efl::eolian::return_traits<void>::type align_priority_set( ::efl::eolian::in_traits<Efl_Ui_Popup_Align>::type first,  ::efl::eolian::in_traits<Efl_Ui_Popup_Align>::type second,  ::efl::eolian::in_traits<Efl_Ui_Popup_Align>::type third,  ::efl::eolian::in_traits<Efl_Ui_Popup_Align>::type fourth,  ::efl::eolian::in_traits<Efl_Ui_Popup_Align>::type fifth) const;
    ::efl::eolian::return_traits<::efl::ui::Popup_Part_Backwall>::type backwall() const;
    static Efl_Class const* _eo_class()
    {
        return EFL_UI_POPUP_CLASS;
    }
    Eo* _eo_ptr() const { return *(reinterpret_cast<Eo **>(const_cast<Popup *>(this))); }
    operator ::efl::ui::Popup() const;
    operator ::efl::ui::Popup&();
    operator ::efl::ui::Popup const&() const;
    /// @cond LOCAL
     ::efl::eolian::address_of_operator<Popup,  ::efl::Container,  ::efl::Content,  ::efl::Loop_Consumer,  ::efl::Object,  ::efl::Part,  ::efl::access::Component,  ::efl::access::Object,  ::efl::canvas::Group,  ::efl::canvas::Object,  ::efl::canvas::Object_Animation,  ::efl::canvas::Pointer,  ::efl::gfx::Color,  ::efl::gfx::Entity,  ::efl::gfx::Filter,  ::efl::gfx::Hint,  ::efl::gfx::Mapping,  ::efl::gfx::Stack,  ::efl::input::Interface,  ::efl::layout::Calc,  ::efl::layout::Group,  ::efl::layout::Signal,  ::efl::ui::Dnd,  ::efl::ui::Factory_Bind,  ::efl::ui::I18n,  ::efl::ui::L10n,  ::efl::ui::Layout_Base,  ::efl::ui::Property_Bind,  ::efl::ui::Selection,  ::efl::ui::View,  ::efl::ui::Widget,  ::efl::ui::Widget_Focus_Manager,  ::efl::ui::Widget_Scrollable_Content,  ::efl::ui::focus::Layer,  ::efl::ui::focus::Manager,  ::efl::ui::focus::Object> operator&() { return {this}; }
     ::efl::eolian::address_of_operator<Popup const ,  ::efl::Container const ,  ::efl::Content const ,  ::efl::Loop_Consumer const ,  ::efl::Object const ,  ::efl::Part const ,  ::efl::access::Component const ,  ::efl::access::Object const ,  ::efl::canvas::Group const ,  ::efl::canvas::Object const ,  ::efl::canvas::Object_Animation const ,  ::efl::canvas::Pointer const ,  ::efl::gfx::Color const ,  ::efl::gfx::Entity const ,  ::efl::gfx::Filter const ,  ::efl::gfx::Hint const ,  ::efl::gfx::Mapping const ,  ::efl::gfx::Stack const ,  ::efl::input::Interface const ,  ::efl::layout::Calc const ,  ::efl::layout::Group const ,  ::efl::layout::Signal const ,  ::efl::ui::Dnd const ,  ::efl::ui::Factory_Bind const ,  ::efl::ui::I18n const ,  ::efl::ui::L10n const ,  ::efl::ui::Layout_Base const ,  ::efl::ui::Property_Bind const ,  ::efl::ui::Selection const ,  ::efl::ui::View const ,  ::efl::ui::Widget const ,  ::efl::ui::Widget_Focus_Manager const ,  ::efl::ui::Widget_Scrollable_Content const ,  ::efl::ui::focus::Layer const ,  ::efl::ui::focus::Manager const ,  ::efl::ui::focus::Object const > operator&() const { return {this}; }
    /// @endcond
};
} } 
}
namespace efl { namespace ui { 
struct Popup : private ::efl::eo::concrete
    ...
    , EO_CXX_INHERIT(::efl::ui::Widget_Scrollable_Content)
    , EO_CXX_INHERIT(::efl::ui::focus::Layer)
    , EO_CXX_INHERIT(::efl::ui::focus::Manager)
    , EO_CXX_INHERIT(::efl::ui::focus::Object)
{
    explicit Popup( ::Eo* eo)
        : ::efl::eo::concrete(eo) {}
    Popup(std::nullptr_t)
        : ::efl::eo::concrete(nullptr) {}
    explicit Popup() = default;
    Popup(Popup const&) = default;
    Popup(Popup&&) = default;
    Popup& operator=(Popup const&) = default;
    Popup& operator=(Popup&&) = default;
    template <typename Derived>
    Popup(Derived&& derived
        , typename std::enable_if<
            ::efl::eo::is_eolian_object<Derived>::value
             && std::is_base_of< Popup, Derived>::value>::type* = 0)
            : ::efl::eo::concrete(derived._eo_ptr()) {}

    Popup( ::efl::eo::instantiate_t)
    {
        ::efl::eolian::do_eo_add( ::efl::eo::concrete::_eo_raw, ::efl::eo::concrete{nullptr}, _eo_class());
    }
    template <typename T>
    explicit Popup( ::efl::eo::instantiate_t, T&& parent, typename std::enable_if< ::efl::eo::is_eolian_object<T>::value>::type* = 0)
    {
        ::efl::eolian::do_eo_add( ::efl::eo::concrete::_eo_raw, parent, _eo_class());
    }
    template <typename F> Popup( ::efl::eo::instantiate_t, F&& f, typename ::std::enable_if< ::efl::eolian::is_constructor_lambda<F, Popup >::value>::type* = 0)
    {
        ::efl::eolian::do_eo_add( ::efl::eo::concrete::_eo_raw, ::efl::eo::concrete{nullptr}, _eo_class(), *this, std::forward<F>(f));
    }
    template <typename T, typename F> Popup(  ::efl::eo::instantiate_t, T&& parent, F&& f, typename ::std::enable_if< ::efl::eolian::is_constructor_lambda<F, Popup >::value && ::efl::eo::is_eolian_object<T>::value>::type* = 0)
    {
    ...
    Eo* _eo_ptr() const { return *(reinterpret_cast<Eo **>(const_cast<Popup *>(this))); }
    static struct backwall_clicked_event
    {
        static Efl_Event_Description const* description()
        { return EFL_UI_POPUP_EVENT_BACKWALL_CLICKED; }
        typedef void parameter_type;
    } const backwall_clicked_event;
#ifdef EFL_CXXPERIMENTAL
    template <typename F>
    typename std::enable_if<std::is_bind_expression<F>::value, ::efl::eolian::signal_connection>::type
    backwall_clicked_event_cb_add(F function)
    {
        return ::efl::eolian::event_add(backwall_clicked_event, *this, function);
    }
    template <typename F>
    typename std::enable_if<!std::is_bind_expression<F>::value, ::efl::eolian::signal_connection>::type
    backwall_clicked_event_cb_add(F function)
    {
        return ::efl::eolian::event_add(backwall_clicked_event, *this, std::bind(function));
    }
#endif
    static struct timeout_event
    {
        static Efl_Event_Description const* description()
        { return EFL_UI_POPUP_EVENT_TIMEOUT; }
        typedef void parameter_type;
    } const timeout_event;
#ifdef EFL_CXXPERIMENTAL
    template <typename F>
    typename std::enable_if<std::is_bind_expression<F>::value, ::efl::eolian::signal_connection>::type
    timeout_event_cb_add(F function)
    {
        return ::efl::eolian::event_add(timeout_event, *this, function);
    }
    template <typename F>
    typename std::enable_if<!std::is_bind_expression<F>::value, ::efl::eolian::signal_connection>::type
    timeout_event_cb_add(F function)
    {
        return ::efl::eolian::event_add(timeout_event, *this, std::bind(function));
    }
#endif
    /// @cond LOCAL
     ::efl::eolian::address_of_operator<Popup,  ::efl::Container,  ::efl::Content,  ::efl::Loop_Consumer,  ::efl::Object,  ::efl::Part,  ::efl::access::Component,  ::efl::access::Object,  ::efl::canvas::Group,  ::efl::canvas::Object,  ::efl::canvas::Object_Animation,  ::efl::canvas::Pointer,  ::efl::gfx::Color,  ::efl::gfx::Entity,  ::efl::gfx::Filter,  ::efl::gfx::Hint,  ::efl::gfx::Mapping,  ::efl::gfx::Stack,  ::efl::input::Interface,  ::efl::layout::Calc,  ::efl::layout::Group,  ::efl::layout::Signal,  ::efl::ui::Dnd,  ::efl::ui::Factory_Bind,  ::efl::ui::I18n,  ::efl::ui::L10n,  ::efl::ui::Layout_Base,  ::efl::ui::Property_Bind,  ::efl::ui::Selection,  ::efl::ui::View,  ::efl::ui::Widget,  ::efl::ui::Widget_Focus_Manager,  ::efl::ui::Widget_Scrollable_Content,  ::efl::ui::focus::Layer,  ::efl::ui::focus::Manager,  ::efl::ui::focus::Object> operator&() { return {this}; }
    ...
    /// @endcond
        ...
        ::efl::eolian::return_traits<::efl::ui::Popup_Part_Backwall>::type backwall() const;
#endif 
    ::efl::eo::wref<Popup> _get_wref() const { return ::efl::eo::wref<Popup>(*this); }
...
#ifdef EFL_CXXPERIMENTAL
    const Popup* operator->() const { return this; }
    Popup* operator->() { return this; }
    operator Eo*() const { return _eo_ptr(); }
#endif 
    friend bool operator==(Popup const& lhs, Popup const& rhs)
    { return lhs._get_concrete() == rhs._get_concrete(); }
    friend bool operator!=(Popup const& lhs, Popup const& rhs)
    { return !(lhs == rhs); }
};
static_assert(sizeof(Popup) == sizeof(Eo*), "");
static_assert(std::is_standard_layout<Popup>::value, "");
} } 
