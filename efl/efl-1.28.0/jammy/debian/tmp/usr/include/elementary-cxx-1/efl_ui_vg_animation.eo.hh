#ifndef EFL_UI_VG_ANIMATION_EO_HH
#define EFL_UI_VG_ANIMATION_EO_HH
#include <Eo.h>
...
#ifndef EFL_UI_VG_ANIMATION_FWD_GUARD
#define EFL_UI_VG_ANIMATION_FWD_GUARD
namespace efl { namespace ui { 
struct Vg_Animation;
} } 
namespace efl { namespace eo { template<> struct is_eolian_object< ::efl::ui::Vg_Animation> : ::std::true_type {}; } }
namespace efl { namespace eo { template<> struct is_eolian_object< ::efl::ui::Vg_Animation&> : ::std::true_type {}; } }
namespace efl { namespace eo { template<> struct is_eolian_object< ::efl::ui::Vg_Animation const> : ::std::true_type {}; } }
namespace efl { namespace eo { template<> struct is_eolian_object< ::efl::ui::Vg_Animation const&> : ::std::true_type {}; } }
#endif
...
struct Vg_Animation {
    ...
    ::efl::eolian::return_traits<void>::type frame_set( ::efl::eolian::in_traits<int>::type frame_num) const;
    ::efl::eolian::return_traits<Eina_Size2D>::type default_view_size_get() const;
    ::efl::eolian::return_traits<Efl_Ui_Vg_Animation_State>::type state_get() const;
    ::efl::eolian::return_traits<int>::type frame_count_get() const;
    ::efl::eolian::return_traits<double>::type min_progress_get() const;
    ::efl::eolian::return_traits<void>::type min_progress_set( ::efl::eolian::in_traits<double>::type min_progress) const;
    ::efl::eolian::return_traits<double>::type max_progress_get() const;
    ::efl::eolian::return_traits<void>::type max_progress_set( ::efl::eolian::in_traits<double>::type max_progress) const;
    ::efl::eolian::return_traits<int>::type min_frame_get() const;
    ::efl::eolian::return_traits<void>::type min_frame_set( ::efl::eolian::in_traits<int>::type min_frame) const;
    ::efl::eolian::return_traits<int>::type max_frame_get() const;
    ::efl::eolian::return_traits<void>::type max_frame_set( ::efl::eolian::in_traits<int>::type max_frame) const;
#ifdef EFL_BETA_API_SUPPORT
    ::efl::eolian::return_traits<bool>::type playing_sector( ::efl::eolian::in_traits< ::efl::eina::string_view>::type start,  ::efl::eolian::in_traits< ::efl::eina::string_view>::type end) const;
#endif
#ifdef EFL_BETA_API_SUPPORT
    ::efl::eolian::return_traits<void>::type value_provider_override( ::efl::eolian::in_traits< ::efl::gfx::vg::Value_Provider>::type value_provider) const;
#endif
    static Efl_Class const* _eo_class()
    {
        return EFL_UI_VG_ANIMATION_CLASS;
    }
    Eo* _eo_ptr() const { return *(reinterpret_cast<Eo **>(const_cast<Vg_Animation *>(this))); }
    operator ::efl::ui::Vg_Animation() const;
    operator ::efl::ui::Vg_Animation&();
    operator ::efl::ui::Vg_Animation const&() const;
    /// @cond LOCAL
     ::efl::eolian::address_of_operator<Vg_Animation,  ::efl::File,  ::efl::Loop_Consumer,  ::efl::Object,  ::efl::Part,  ::efl::Playable,  ::efl::Player,  ::efl::access::Component,  ::efl::access::Object,  ::efl::canvas::Group,  ::efl::canvas::Object,  ::efl::canvas::Object_Animation,  ::efl::canvas::Pointer,  ::efl::gfx::Color,  ::efl::gfx::Entity,  ::efl::gfx::Filter,  ::efl::gfx::Hint,  ::efl::gfx::Mapping,  ::efl::gfx::Stack,  ::efl::gfx::View,  ::efl::input::Interface,  ::efl::ui::Dnd,  ::efl::ui::I18n,  ::efl::ui::L10n,  ::efl::ui::Property_Bind,  ::efl::ui::Selection,  ::efl::ui::View,  ::efl::ui::Widget,  ::efl::ui::focus::Object> operator&() { return {this}; }
     ::efl::eolian::address_of_operator<Vg_Animation const ,  ::efl::File const ,  ::efl::Loop_Consumer const ,  ::efl::Object const ,  ::efl::Part const ,  ::efl::Playable const ,  ::efl::Player const ,  ::efl::access::Component const ,  ::efl::access::Object const ,  ::efl::canvas::Group const ,  ::efl::canvas::Object const ,  ::efl::canvas::Object_Animation const ,  ::efl::canvas::Pointer const ,  ::efl::gfx::Color const ,  ::efl::gfx::Entity const ,  ::efl::gfx::Filter const ,  ::efl::gfx::Hint const ,  ::efl::gfx::Mapping const ,  ::efl::gfx::Stack const ,  ::efl::gfx::View const ,  ::efl::input::Interface const ,  ::efl::ui::Dnd const ,  ::efl::ui::I18n const ,  ::efl::ui::L10n const ,  ::efl::ui::Property_Bind const ,  ::efl::ui::Selection const ,  ::efl::ui::View const ,  ::efl::ui::Widget const ,  ::efl::ui::focus::Object const > operator&() const { return {this}; }
    /// @endcond
};
} } 
}
namespace efl { namespace ui { 
struct Vg_Animation : private ::efl::eo::concrete
...
{
    explicit Vg_Animation( ::Eo* eo)
        : ::efl::eo::concrete(eo) {}
    Vg_Animation(std::nullptr_t)
        : ::efl::eo::concrete(nullptr) {}
    explicit Vg_Animation() = default;
    Vg_Animation(Vg_Animation const&) = default;
    Vg_Animation(Vg_Animation&&) = default;
    Vg_Animation& operator=(Vg_Animation const&) = default;
    Vg_Animation& operator=(Vg_Animation&&) = default;
    template <typename Derived>
    Vg_Animation(Derived&& derived
        , typename std::enable_if<
            ::efl::eo::is_eolian_object<Derived>::value
             && std::is_base_of< Vg_Animation, Derived>::value>::type* = 0)
            : ::efl::eo::concrete(derived._eo_ptr()) {}

    Vg_Animation( ::efl::eo::instantiate_t)
    {
        ::efl::eolian::do_eo_add( ::efl::eo::concrete::_eo_raw, ::efl::eo::concrete{nullptr}, _eo_class());
    }
    template <typename T>
    explicit Vg_Animation( ::efl::eo::instantiate_t, T&& parent, typename std::enable_if< ::efl::eo::is_eolian_object<T>::value>::type* = 0)
    {
        ::efl::eolian::do_eo_add( ::efl::eo::concrete::_eo_raw, parent, _eo_class());
    }
    template <typename F> Vg_Animation( ::efl::eo::instantiate_t, F&& f, typename ::std::enable_if< ::efl::eolian::is_constructor_lambda<F, Vg_Animation >::value>::type* = 0)
    {
        ::efl::eolian::do_eo_add( ::efl::eo::concrete::_eo_raw, ::efl::eo::concrete{nullptr}, _eo_class(), *this, std::forward<F>(f));
    }
    template <typename T, typename F> Vg_Animation(  ::efl::eo::instantiate_t, T&& parent, F&& f, typename ::std::enable_if< ::efl::eolian::is_constructor_lambda<F, Vg_Animation >::value && ::efl::eo::is_eolian_object<T>::value>::type* = 0)
    {
    ...
    /// @cond LOCAL
     ...
     ::efl::eolian::address_of_operator<Vg_Animation const ,  ::efl::File const ,  ::efl::Loop_Consumer const ,  ::efl::Object const ,  ::efl::Part const ,  ::efl::Playable const ,  ::efl::Player const ,  ::efl::access::Component const ,  ::efl::access::Object const ,  ::efl::canvas::Group const ,  ::efl::canvas::Object const ,  ::efl::canvas::Object_Animation const ,  ::efl::canvas::Pointer const ,  ::efl::gfx::Color const ,  ::efl::gfx::Entity const ,  ::efl::gfx::Filter const ,  ::efl::gfx::Hint const ,  ::efl::gfx::Mapping const ,  ::efl::gfx::Stack const ,  ::efl::gfx::View const ,  ::efl::input::Interface const ,  ::efl::ui::Dnd const ,  ::efl::ui::I18n const ,  ::efl::ui::L10n const ,  ::efl::ui::Property_Bind const ,  ::efl::ui::Selection const ,  ::efl::ui::View const ,  ::efl::ui::Widget const ,  ::efl::ui::focus::Object const > operator&() const { return {this}; }
    /// @endcond
    ::efl::eo::wref<Vg_Animation> _get_wref() const { return ::efl::eo::wref<Vg_Animation>(*this); }
    ...
    const Vg_Animation* operator->() const { return this; }
    Vg_Animation* operator->() { return this; }
    operator Eo*() const { return _eo_ptr(); }
#endif 
    friend bool operator==(Vg_Animation const& lhs, Vg_Animation const& rhs)
    { return lhs._get_concrete() == rhs._get_concrete(); }
    friend bool operator!=(Vg_Animation const& lhs, Vg_Animation const& rhs)
    { return !(lhs == rhs); }
};
static_assert(sizeof(Vg_Animation) == sizeof(Eo*), "");
static_assert(std::is_standard_layout<Vg_Animation>::value, "");
} } 
