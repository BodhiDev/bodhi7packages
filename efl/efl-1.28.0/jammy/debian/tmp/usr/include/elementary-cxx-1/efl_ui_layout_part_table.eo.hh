#ifndef EFL_UI_LAYOUT_PART_TABLE_EO_HH
#define EFL_UI_LAYOUT_PART_TABLE_EO_HH
#include <Eo.h>
...
#ifndef EFL_UI_LAYOUT_PART_TABLE_FWD_GUARD
#define EFL_UI_LAYOUT_PART_TABLE_FWD_GUARD
namespace efl { namespace ui { 
struct Layout_Part_Table;
} } 
namespace efl { namespace eo { template<> struct is_eolian_object< ::efl::ui::Layout_Part_Table> : ::std::true_type {}; } }
namespace efl { namespace eo { template<> struct is_eolian_object< ::efl::ui::Layout_Part_Table&> : ::std::true_type {}; } }
namespace efl { namespace eo { template<> struct is_eolian_object< ::efl::ui::Layout_Part_Table const> : ::std::true_type {}; } }
namespace efl { namespace eo { template<> struct is_eolian_object< ::efl::ui::Layout_Part_Table const&> : ::std::true_type {}; } }
#endif
...
struct Layout_Part_Table {
    ...
    {
        return EFL_UI_LAYOUT_PART_TABLE_CLASS;
    }
    Eo* _eo_ptr() const { return *(reinterpret_cast<Eo **>(const_cast<Layout_Part_Table *>(this))); }
    operator ::efl::ui::Layout_Part_Table() const;
    operator ::efl::ui::Layout_Part_Table&();
    operator ::efl::ui::Layout_Part_Table const&() const;
    /// @cond LOCAL
     ::efl::eolian::address_of_operator<Layout_Part_Table,  ::efl::Container,  ::efl::Object,  ::efl::Pack,  ::efl::Pack_Table> operator&() { return {this}; }
     ::efl::eolian::address_of_operator<Layout_Part_Table const ,  ::efl::Container const ,  ::efl::Object const ,  ::efl::Pack const ,  ::efl::Pack_Table const > operator&() const { return {this}; }
    /// @endcond
};
} } 
}
