#ifndef EFL_UI_RELATIVE_CONTAINER_EO_HH
#define EFL_UI_RELATIVE_CONTAINER_EO_HH
#include <Eo.h>
...
#ifndef EFL_UI_RELATIVE_CONTAINER_FWD_GUARD
#define EFL_UI_RELATIVE_CONTAINER_FWD_GUARD
namespace efl { namespace ui { 
struct Relative_Container;
} } 
namespace efl { namespace eo { template<> struct is_eolian_object< ::efl::ui::Relative_Container> : ::std::true_type {}; } }
namespace efl { namespace eo { template<> struct is_eolian_object< ::efl::ui::Relative_Container&> : ::std::true_type {}; } }
namespace efl { namespace eo { template<> struct is_eolian_object< ::efl::ui::Relative_Container const> : ::std::true_type {}; } }
namespace efl { namespace eo { template<> struct is_eolian_object< ::efl::ui::Relative_Container const&> : ::std::true_type {}; } }
#endif
...
namespace efl { namespace ui { 
struct Relative_Container {
    ::efl::eolian::return_traits<void>::type relation_left_get( ::efl::eolian::in_traits< ::efl::gfx::Entity>::type child,  ::efl::eolian::out_traits< ::efl::gfx::Entity>::type base,  ::efl::eolian::out_traits<Efl_Gfx_Align>::type relative_position) const;
    ::efl::eolian::return_traits<void>::type relation_left_set( ::efl::eolian::in_traits< ::efl::gfx::Entity>::type child,  ::efl::eolian::in_traits< ::efl::gfx::Entity>::type base,  ::efl::eolian::in_traits<Efl_Gfx_Align>::type relative_position) const;
    ::efl::eolian::return_traits<void>::type relation_right_get( ::efl::eolian::in_traits< ::efl::gfx::Entity>::type child,  ::efl::eolian::out_traits< ::efl::gfx::Entity>::type base,  ::efl::eolian::out_traits<Efl_Gfx_Align>::type relative_position) const;
    ::efl::eolian::return_traits<void>::type relation_right_set( ::efl::eolian::in_traits< ::efl::gfx::Entity>::type child,  ::efl::eolian::in_traits< ::efl::gfx::Entity>::type base,  ::efl::eolian::in_traits<Efl_Gfx_Align>::type relative_position) const;
    ::efl::eolian::return_traits<void>::type relation_top_get( ::efl::eolian::in_traits< ::efl::gfx::Entity>::type child,  ::efl::eolian::out_traits< ::efl::gfx::Entity>::type base,  ::efl::eolian::out_traits<Efl_Gfx_Align>::type relative_position) const;
    ::efl::eolian::return_traits<void>::type relation_top_set( ::efl::eolian::in_traits< ::efl::gfx::Entity>::type child,  ::efl::eolian::in_traits< ::efl::gfx::Entity>::type base,  ::efl::eolian::in_traits<Efl_Gfx_Align>::type relative_position) const;
    ::efl::eolian::return_traits<void>::type relation_bottom_get( ::efl::eolian::in_traits< ::efl::gfx::Entity>::type child,  ::efl::eolian::out_traits< ::efl::gfx::Entity>::type base,  ::efl::eolian::out_traits<Efl_Gfx_Align>::type relative_position) const;
    ::efl::eolian::return_traits<void>::type relation_bottom_set( ::efl::eolian::in_traits< ::efl::gfx::Entity>::type child,  ::efl::eolian::in_traits< ::efl::gfx::Entity>::type base,  ::efl::eolian::in_traits<Efl_Gfx_Align>::type relative_position) const;
    static Efl_Class const* _eo_class()
    {
        return EFL_UI_RELATIVE_CONTAINER_CLASS;
    }
    Eo* _eo_ptr() const { return *(reinterpret_cast<Eo **>(const_cast<Relative_Container *>(this))); }
    operator ::efl::ui::Relative_Container() const;
    operator ::efl::ui::Relative_Container&();
    operator ::efl::ui::Relative_Container const&() const;
    /// @cond LOCAL
     ::efl::eolian::address_of_operator<Relative_Container,  ::efl::Container,  ::efl::Loop_Consumer,  ::efl::Object,  ::efl::Pack,  ::efl::Pack_Layout,  ::efl::Part,  ::efl::access::Component,  ::efl::access::Object,  ::efl::canvas::Group,  ::efl::canvas::Object,  ::efl::canvas::Object_Animation,  ::efl::canvas::Pointer,  ::efl::gfx::Color,  ::efl::gfx::Entity,  ::efl::gfx::Filter,  ::efl::gfx::Hint,  ::efl::gfx::Mapping,  ::efl::gfx::Stack,  ::efl::input::Interface,  ::efl::ui::Dnd,  ::efl::ui::I18n,  ::efl::ui::L10n,  ::efl::ui::Property_Bind,  ::efl::ui::Selection,  ::efl::ui::View,  ::efl::ui::Widget,  ::efl::ui::focus::Object> operator&() { return {this}; }
     ::efl::eolian::address_of_operator<Relative_Container const ,  ::efl::Container const ,  ::efl::Loop_Consumer const ,  ::efl::Object const ,  ::efl::Pack const ,  ::efl::Pack_Layout const ,  ::efl::Part const ,  ::efl::access::Component const ,  ::efl::access::Object const ,  ::efl::canvas::Group const ,  ::efl::canvas::Object const ,  ::efl::canvas::Object_Animation const ,  ::efl::canvas::Pointer const ,  ::efl::gfx::Color const ,  ::efl::gfx::Entity const ,  ::efl::gfx::Filter const ,  ::efl::gfx::Hint const ,  ::efl::gfx::Mapping const ,  ::efl::gfx::Stack const ,  ::efl::input::Interface const ,  ::efl::ui::Dnd const ,  ::efl::ui::I18n const ,  ::efl::ui::L10n const ,  ::efl::ui::Property_Bind const ,  ::efl::ui::Selection const ,  ::efl::ui::View const ,  ::efl::ui::Widget const ,  ::efl::ui::focus::Object const > operator&() const { return {this}; }
    /// @endcond
};
} } 
}
namespace efl { namespace ui { 
struct Relative_Container : private ::efl::eo::concrete
...
{
    explicit Relative_Container( ::Eo* eo)
        : ::efl::eo::concrete(eo) {}
    Relative_Container(std::nullptr_t)
        : ::efl::eo::concrete(nullptr) {}
    explicit Relative_Container() = default;
    Relative_Container(Relative_Container const&) = default;
    Relative_Container(Relative_Container&&) = default;
    Relative_Container& operator=(Relative_Container const&) = default;
    Relative_Container& operator=(Relative_Container&&) = default;
    template <typename Derived>
    Relative_Container(Derived&& derived
        , typename std::enable_if<
            ::efl::eo::is_eolian_object<Derived>::value
             && std::is_base_of< Relative_Container, Derived>::value>::type* = 0)
            : ::efl::eo::concrete(derived._eo_ptr()) {}

    Relative_Container( ::efl::eo::instantiate_t)
    {
        ::efl::eolian::do_eo_add( ::efl::eo::concrete::_eo_raw, ::efl::eo::concrete{nullptr}, _eo_class());
    }
    template <typename T>
    explicit Relative_Container( ::efl::eo::instantiate_t, T&& parent, typename std::enable_if< ::efl::eo::is_eolian_object<T>::value>::type* = 0)
    {
        ::efl::eolian::do_eo_add( ::efl::eo::concrete::_eo_raw, parent, _eo_class());
    }
    template <typename F> Relative_Container( ::efl::eo::instantiate_t, F&& f, typename ::std::enable_if< ::efl::eolian::is_constructor_lambda<F, Relative_Container >::value>::type* = 0)
    {
        ::efl::eolian::do_eo_add( ::efl::eo::concrete::_eo_raw, ::efl::eo::concrete{nullptr}, _eo_class(), *this, std::forward<F>(f));
    }
    template <typename T, typename F> Relative_Container(  ::efl::eo::instantiate_t, T&& parent, F&& f, typename ::std::enable_if< ::efl::eolian::is_constructor_lambda<F, Relative_Container >::value && ::efl::eo::is_eolian_object<T>::value>::type* = 0)
    {
    ...
    /// @cond LOCAL
     ...
     ::efl::eolian::address_of_operator<Relative_Container const ,  ::efl::Container const ,  ::efl::Loop_Consumer const ,  ::efl::Object const ,  ::efl::Pack const ,  ::efl::Pack_Layout const ,  ::efl::Part const ,  ::efl::access::Component const ,  ::efl::access::Object const ,  ::efl::canvas::Group const ,  ::efl::canvas::Object const ,  ::efl::canvas::Object_Animation const ,  ::efl::canvas::Pointer const ,  ::efl::gfx::Color const ,  ::efl::gfx::Entity const ,  ::efl::gfx::Filter const ,  ::efl::gfx::Hint const ,  ::efl::gfx::Mapping const ,  ::efl::gfx::Stack const ,  ::efl::input::Interface const ,  ::efl::ui::Dnd const ,  ::efl::ui::I18n const ,  ::efl::ui::L10n const ,  ::efl::ui::Property_Bind const ,  ::efl::ui::Selection const ,  ::efl::ui::View const ,  ::efl::ui::Widget const ,  ::efl::ui::focus::Object const > operator&() const { return {this}; }
    /// @endcond
    ::efl::eo::wref<Relative_Container> _get_wref() const { return ::efl::eo::wref<Relative_Container>(*this); }
    ...
    const Relative_Container* operator->() const { return this; }
    Relative_Container* operator->() { return this; }
    operator Eo*() const { return _eo_ptr(); }
#endif 
    friend bool operator==(Relative_Container const& lhs, Relative_Container const& rhs)
    { return lhs._get_concrete() == rhs._get_concrete(); }
    friend bool operator!=(Relative_Container const& lhs, Relative_Container const& rhs)
    { return !(lhs == rhs); }
};
static_assert(sizeof(Relative_Container) == sizeof(Eo*), "");
static_assert(std::is_standard_layout<Relative_Container>::value, "");
} } 
