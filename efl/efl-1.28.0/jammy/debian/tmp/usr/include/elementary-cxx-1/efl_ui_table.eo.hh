#ifndef EFL_UI_TABLE_EO_HH
#define EFL_UI_TABLE_EO_HH
#include <Eo.h>
...
namespace efl { namespace ui { 
struct Table {
    ::efl::eolian::return_traits<void>::type homogeneous_get( ::efl::eolian::out_traits<bool>::type homogeneoush,  ::efl::eolian::out_traits<bool>::type homogeneousv) const;
    ::efl::eolian::return_traits<void>::type homogeneous_set( ::efl::eolian::in_traits<bool>::type homogeneoush,  ::efl::eolian::in_traits<bool>::type homogeneousv) const;
    static Efl_Class const* _eo_class()
    {
        return EFL_UI_TABLE_CLASS;
    }
    Eo* _eo_ptr() const { return *(reinterpret_cast<Eo **>(const_cast<Table *>(this))); }
    operator ::efl::ui::Table() const;
    operator ::efl::ui::Table&();
    operator ::efl::ui::Table const&() const;
    /// @cond LOCAL
     ::efl::eolian::address_of_operator<Table,  ::efl::Container,  ::efl::Loop_Consumer,  ::efl::Object,  ::efl::Pack,  ::efl::Pack_Layout,  ::efl::Pack_Table,  ::efl::Part,  ::efl::access::Component,  ::efl::access::Object,  ::efl::canvas::Group,  ::efl::canvas::Object,  ::efl::canvas::Object_Animation,  ::efl::canvas::Pointer,  ::efl::gfx::Arrangement,  ::efl::gfx::Color,  ::efl::gfx::Entity,  ::efl::gfx::Filter,  ::efl::gfx::Hint,  ::efl::gfx::Mapping,  ::efl::gfx::Stack,  ::efl::input::Interface,  ::efl::ui::Dnd,  ::efl::ui::I18n,  ::efl::ui::L10n,  ::efl::ui::Layout_Orientable,  ::efl::ui::Property_Bind,  ::efl::ui::Selection,  ::efl::ui::View,  ::efl::ui::Widget,  ::efl::ui::focus::Object> operator&() { return {this}; }
     ::efl::eolian::address_of_operator<Table const ,  ::efl::Container const ,  ::efl::Loop_Consumer const ,  ::efl::Object const ,  ::efl::Pack const ,  ::efl::Pack_Layout const ,  ::efl::Pack_Table const ,  ::efl::Part const ,  ::efl::access::Component const ,  ::efl::access::Object const ,  ::efl::canvas::Group const ,  ::efl::canvas::Object const ,  ::efl::canvas::Object_Animation const ,  ::efl::canvas::Pointer const ,  ::efl::gfx::Arrangement const ,  ::efl::gfx::Color const ,  ::efl::gfx::Entity const ,  ::efl::gfx::Filter const ,  ::efl::gfx::Hint const ,  ::efl::gfx::Mapping const ,  ::efl::gfx::Stack const ,  ::efl::input::Interface const ,  ::efl::ui::Dnd const ,  ::efl::ui::I18n const ,  ::efl::ui::L10n const ,  ::efl::ui::Layout_Orientable const ,  ::efl::ui::Property_Bind const ,  ::efl::ui::Selection const ,  ::efl::ui::View const ,  ::efl::ui::Widget const ,  ::efl::ui::focus::Object const > operator&() const { return {this}; }
    /// @endcond
};
} } 
}
