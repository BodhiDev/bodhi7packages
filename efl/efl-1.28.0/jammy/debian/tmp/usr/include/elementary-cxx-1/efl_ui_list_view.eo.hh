#ifndef EFL_UI_LIST_VIEW_EO_HH
#define EFL_UI_LIST_VIEW_EO_HH
#include <Eo.h>
...
#ifndef EFL_UI_LIST_VIEW_FWD_GUARD
#define EFL_UI_LIST_VIEW_FWD_GUARD
namespace efl { namespace ui { 
struct List_View;
} } 
namespace efl { namespace eo { template<> struct is_eolian_object< ::efl::ui::List_View> : ::std::true_type {}; } }
namespace efl { namespace eo { template<> struct is_eolian_object< ::efl::ui::List_View&> : ::std::true_type {}; } }
namespace efl { namespace eo { template<> struct is_eolian_object< ::efl::ui::List_View const> : ::std::true_type {}; } }
namespace efl { namespace eo { template<> struct is_eolian_object< ::efl::ui::List_View const&> : ::std::true_type {}; } }
#endif
...
struct List_View {
    ...
    {
        return EFL_UI_LIST_VIEW_CLASS;
    }
    Eo* _eo_ptr() const { return *(reinterpret_cast<Eo **>(const_cast<List_View *>(this))); }
    operator ::efl::ui::List_View() const;
    operator ::efl::ui::List_View&();
    operator ::efl::ui::List_View const&() const;
    /// @cond LOCAL
     ::efl::eolian::address_of_operator<List_View,  ::efl::Container,  ::efl::Loop_Consumer,  ::efl::Object,  ::efl::Part,  ::efl::access::Component,  ::efl::access::Object,  ::efl::canvas::Group,  ::efl::canvas::Object,  ::efl::canvas::Object_Animation,  ::efl::canvas::Pointer,  ::efl::gfx::Color,  ::efl::gfx::Entity,  ::efl::gfx::Filter,  ::efl::gfx::Hint,  ::efl::gfx::Mapping,  ::efl::gfx::Stack,  ::efl::input::Interface,  ::efl::layout::Calc,  ::efl::layout::Group,  ::efl::layout::Signal,  ::efl::ui::Collection_View,  ::efl::ui::Dnd,  ::efl::ui::Factory_Bind,  ::efl::ui::I18n,  ::efl::ui::Item_Clickable,  ::efl::ui::L10n,  ::efl::ui::Layout_Base,  ::efl::ui::Layout_Orientable,  ::efl::ui::Multi_Selectable,  ::efl::ui::Multi_Selectable_Index_Range,  ::efl::ui::Property_Bind,  ::efl::ui::Scrollable,  ::efl::ui::Scrollbar,  ::efl::ui::Selection,  ::efl::ui::Single_Selectable,  ::efl::ui::View,  ::efl::ui::Widget,  ::efl::ui::Widget_Focus_Manager,  ::efl::ui::focus::Manager,  ::efl::ui::focus::Manager_Sub,  ::efl::ui::focus::Object> operator&() { return {this}; }
     ::efl::eolian::address_of_operator<List_View const ,  ::efl::Container const ,  ::efl::Loop_Consumer const ,  ::efl::Object const ,  ::efl::Part const ,  ::efl::access::Component const ,  ::efl::access::Object const ,  ::efl::canvas::Group const ,  ::efl::canvas::Object const ,  ::efl::canvas::Object_Animation const ,  ::efl::canvas::Pointer const ,  ::efl::gfx::Color const ,  ::efl::gfx::Entity const ,  ::efl::gfx::Filter const ,  ::efl::gfx::Hint const ,  ::efl::gfx::Mapping const ,  ::efl::gfx::Stack const ,  ::efl::input::Interface const ,  ::efl::layout::Calc const ,  ::efl::layout::Group const ,  ::efl::layout::Signal const ,  ::efl::ui::Collection_View const ,  ::efl::ui::Dnd const ,  ::efl::ui::Factory_Bind const ,  ::efl::ui::I18n const ,  ::efl::ui::Item_Clickable const ,  ::efl::ui::L10n const ,  ::efl::ui::Layout_Base const ,  ::efl::ui::Layout_Orientable const ,  ::efl::ui::Multi_Selectable const ,  ::efl::ui::Multi_Selectable_Index_Range const ,  ::efl::ui::Property_Bind const ,  ::efl::ui::Scrollable const ,  ::efl::ui::Scrollbar const ,  ::efl::ui::Selection const ,  ::efl::ui::Single_Selectable const ,  ::efl::ui::View const ,  ::efl::ui::Widget const ,  ::efl::ui::Widget_Focus_Manager const ,  ::efl::ui::focus::Manager const ,  ::efl::ui::focus::Manager_Sub const ,  ::efl::ui::focus::Object const > operator&() const { return {this}; }
    /// @endcond
};
} } 
}
namespace efl { namespace ui { 
struct List_View : private ::efl::eo::concrete
...
{
    explicit List_View( ::Eo* eo)
        : ::efl::eo::concrete(eo) {}
    List_View(std::nullptr_t)
        : ::efl::eo::concrete(nullptr) {}
    explicit List_View() = default;
    ...
    List_View(Derived&& derived
        , typename std::enable_if<
            ::efl::eo::is_eolian_object<Derived>::value
             && std::is_base_of< List_View, Derived>::value>::type* = 0)
            : ::efl::eo::concrete(derived._eo_ptr()) {}

    List_View( ::efl::eo::instantiate_t)
    {
        ::efl::eolian::do_eo_add( ::efl::eo::concrete::_eo_raw, ::efl::eo::concrete{nullptr}, _eo_class());
    }
    template <typename T>
    explicit List_View( ::efl::eo::instantiate_t, T&& parent, typename std::enable_if< ::efl::eo::is_eolian_object<T>::value>::type* = 0)
    {
        ::efl::eolian::do_eo_add( ::efl::eo::concrete::_eo_raw, parent, _eo_class());
    }
    template <typename F> List_View( ::efl::eo::instantiate_t, F&& f, typename ::std::enable_if< ::efl::eolian::is_constructor_lambda<F, List_View >::value>::type* = 0)
    {
        ::efl::eolian::do_eo_add( ::efl::eo::concrete::_eo_raw, ::efl::eo::concrete{nullptr}, _eo_class(), *this, std::forward<F>(f));
    }
    template <typename T, typename F> List_View(  ::efl::eo::instantiate_t, T&& parent, F&& f, typename ::std::enable_if< ::efl::eolian::is_constructor_lambda<F, List_View >::value && ::efl::eo::is_eolian_object<T>::value>::type* = 0)
    {
    ...
    /// @cond LOCAL
     ...
     ::efl::eolian::address_of_operator<List_View const ,  ::efl::Container const ,  ::efl::Loop_Consumer const ,  ::efl::Object const ,  ::efl::Part const ,  ::efl::access::Component const ,  ::efl::access::Object const ,  ::efl::canvas::Group const ,  ::efl::canvas::Object const ,  ::efl::canvas::Object_Animation const ,  ::efl::canvas::Pointer const ,  ::efl::gfx::Color const ,  ::efl::gfx::Entity const ,  ::efl::gfx::Filter const ,  ::efl::gfx::Hint const ,  ::efl::gfx::Mapping const ,  ::efl::gfx::Stack const ,  ::efl::input::Interface const ,  ::efl::layout::Calc const ,  ::efl::layout::Group const ,  ::efl::layout::Signal const ,  ::efl::ui::Collection_View const ,  ::efl::ui::Dnd const ,  ::efl::ui::Factory_Bind const ,  ::efl::ui::I18n const ,  ::efl::ui::Item_Clickable const ,  ::efl::ui::L10n const ,  ::efl::ui::Layout_Base const ,  ::efl::ui::Layout_Orientable const ,  ::efl::ui::Multi_Selectable const ,  ::efl::ui::Multi_Selectable_Index_Range const ,  ::efl::ui::Property_Bind const ,  ::efl::ui::Scrollable const ,  ::efl::ui::Scrollbar const ,  ::efl::ui::Selection const ,  ::efl::ui::Single_Selectable const ,  ::efl::ui::View const ,  ::efl::ui::Widget const ,  ::efl::ui::Widget_Focus_Manager const ,  ::efl::ui::focus::Manager const ,  ::efl::ui::focus::Manager_Sub const ,  ::efl::ui::focus::Object const > operator&() const { return {this}; }
    /// @endcond
    ::efl::eo::wref<List_View> _get_wref() const { return ::efl::eo::wref<List_View>(*this); }
    ...
    const List_View* operator->() const { return this; }
    List_View* operator->() { return this; }
    operator Eo*() const { return _eo_ptr(); }
#endif 
    friend bool operator==(List_View const& lhs, List_View const& rhs)
    { return lhs._get_concrete() == rhs._get_concrete(); }
    friend bool operator!=(List_View const& lhs, List_View const& rhs)
    { return !(lhs == rhs); }
};
static_assert(sizeof(List_View) == sizeof(Eo*), "");
static_assert(std::is_standard_layout<List_View>::value, "");
} } 
