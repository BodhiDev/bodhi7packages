#ifndef EFL_UI_DEFAULT_ITEM_EO_HH
#define EFL_UI_DEFAULT_ITEM_EO_HH
#include <Eo.h>
...
namespace efl { namespace ui { 
struct Default_Item {
    ::efl::eolian::return_traits<::efl::ui::Layout_Part_Content>::type extra() const;
    ::efl::eolian::return_traits<::efl::ui::Layout_Part_Content>::type icon() const;
    ::efl::eolian::return_traits<::efl::ui::Layout_Part_Text>::type text() const;
    static Efl_Class const* _eo_class()
    {
        return EFL_UI_DEFAULT_ITEM_CLASS;
    }
    Eo* _eo_ptr() const { return *(reinterpret_cast<Eo **>(const_cast<Default_Item *>(this))); }
    operator ::efl::ui::Default_Item() const;
    operator ::efl::ui::Default_Item&();
    operator ::efl::ui::Default_Item const&() const;
    /// @cond LOCAL
     ::efl::eolian::address_of_operator<Default_Item,  ::efl::Container,  ::efl::Content,  ::efl::Loop_Consumer,  ::efl::Object,  ::efl::Part,  ::efl::Text,  ::efl::Text_Markup,  ::efl::access::Component,  ::efl::access::Object,  ::efl::canvas::Group,  ::efl::canvas::Object,  ::efl::canvas::Object_Animation,  ::efl::canvas::Pointer,  ::efl::gfx::Color,  ::efl::gfx::Entity,  ::efl::gfx::Filter,  ::efl::gfx::Hint,  ::efl::gfx::Mapping,  ::efl::gfx::Stack,  ::efl::input::Clickable,  ::efl::input::Interface,  ::efl::layout::Calc,  ::efl::layout::Group,  ::efl::layout::Signal,  ::efl::ui::Dnd,  ::efl::ui::Factory_Bind,  ::efl::ui::I18n,  ::efl::ui::Item,  ::efl::ui::L10n,  ::efl::ui::Layout_Base,  ::efl::ui::Property_Bind,  ::efl::ui::Selectable,  ::efl::ui::Selection,  ::efl::ui::View,  ::efl::ui::Widget,  ::efl::ui::focus::Object> operator&() { return {this}; }
     ::efl::eolian::address_of_operator<Default_Item const ,  ::efl::Container const ,  ::efl::Content const ,  ::efl::Loop_Consumer const ,  ::efl::Object const ,  ::efl::Part const ,  ::efl::Text const ,  ::efl::Text_Markup const ,  ::efl::access::Component const ,  ::efl::access::Object const ,  ::efl::canvas::Group const ,  ::efl::canvas::Object const ,  ::efl::canvas::Object_Animation const ,  ::efl::canvas::Pointer const ,  ::efl::gfx::Color const ,  ::efl::gfx::Entity const ,  ::efl::gfx::Filter const ,  ::efl::gfx::Hint const ,  ::efl::gfx::Mapping const ,  ::efl::gfx::Stack const ,  ::efl::input::Clickable const ,  ::efl::input::Interface const ,  ::efl::layout::Calc const ,  ::efl::layout::Group const ,  ::efl::layout::Signal const ,  ::efl::ui::Dnd const ,  ::efl::ui::Factory_Bind const ,  ::efl::ui::I18n const ,  ::efl::ui::Item const ,  ::efl::ui::L10n const ,  ::efl::ui::Layout_Base const ,  ::efl::ui::Property_Bind const ,  ::efl::ui::Selectable const ,  ::efl::ui::Selection const ,  ::efl::ui::View const ,  ::efl::ui::Widget const ,  ::efl::ui::focus::Object const > operator&() const { return {this}; }
    /// @endcond
};
} } 
}
namespace efl { namespace ui { 
struct Default_Item : private ::efl::eo::concrete
...
{
    explicit Default_Item( ::Eo* eo)
        : ::efl::eo::concrete(eo) {}
    Default_Item(std::nullptr_t)
        : ::efl::eo::concrete(nullptr) {}
    explicit Default_Item() = default;
    Default_Item(Default_Item const&) = default;
    Default_Item(Default_Item&&) = default;
    Default_Item& operator=(Default_Item const&) = default;
    Default_Item& operator=(Default_Item&&) = default;
    template <typename Derived>
    Default_Item(Derived&& derived
        , typename std::enable_if<
            ::efl::eo::is_eolian_object<Derived>::value
             && std::is_base_of< Default_Item, Derived>::value>::type* = 0)
    ...
    /// @endcond
        ...
        ::efl::eolian::return_traits<::efl::ui::Layout_Part_Text>::type text() const;
#endif 
    ::efl::eo::wref<Default_Item> _get_wref() const { return ::efl::eo::wref<Default_Item>(*this); }
...
#ifdef EFL_CXXPERIMENTAL
    const Default_Item* operator->() const { return this; }
    Default_Item* operator->() { return this; }
    operator Eo*() const { return _eo_ptr(); }
#endif 
    friend bool operator==(Default_Item const& lhs, Default_Item const& rhs)
    { return lhs._get_concrete() == rhs._get_concrete(); }
    friend bool operator!=(Default_Item const& lhs, Default_Item const& rhs)
    { return !(lhs == rhs); }
};
static_assert(sizeof(Default_Item) == sizeof(Eo*), "");
static_assert(std::is_standard_layout<Default_Item>::value, "");
} } 
