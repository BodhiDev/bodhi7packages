#ifndef EFL_UI_POSITION_MANAGER_GRID_EO_HH
#define EFL_UI_POSITION_MANAGER_GRID_EO_HH
#include <Eo.h>
...
#ifndef EFL_UI_POSITION_MANAGER_GRID_FWD_GUARD
#define EFL_UI_POSITION_MANAGER_GRID_FWD_GUARD
namespace efl { namespace ui { namespace position_manager { 
struct Grid;
} } } 
namespace efl { namespace eo { template<> struct is_eolian_object< ::efl::ui::position_manager::Grid> : ::std::true_type {}; } }
namespace efl { namespace eo { template<> struct is_eolian_object< ::efl::ui::position_manager::Grid&> : ::std::true_type {}; } }
namespace efl { namespace eo { template<> struct is_eolian_object< ::efl::ui::position_manager::Grid const> : ::std::true_type {}; } }
namespace efl { namespace eo { template<> struct is_eolian_object< ::efl::ui::position_manager::Grid const&> : ::std::true_type {}; } }
#endif
...
struct Grid {
    ...
    {
        return EFL_UI_POSITION_MANAGER_GRID_CLASS;
    }
    Eo* _eo_ptr() const { return *(reinterpret_cast<Eo **>(const_cast<Grid *>(this))); }
    operator ::efl::ui::position_manager::Grid() const;
    operator ::efl::ui::position_manager::Grid&();
    operator ::efl::ui::position_manager::Grid const&() const;
    /// @cond LOCAL
     ::efl::eolian::address_of_operator<Grid,  ::efl::Object,  ::efl::ui::Layout_Orientable,  ::efl::ui::position_manager::Data_Access_V1,  ::efl::ui::position_manager::Entity> operator&() { return {this}; }
     ::efl::eolian::address_of_operator<Grid const ,  ::efl::Object const ,  ::efl::ui::Layout_Orientable const ,  ::efl::ui::position_manager::Data_Access_V1 const ,  ::efl::ui::position_manager::Entity const > operator&() const { return {this}; }
    /// @endcond
};
} } } 
}
