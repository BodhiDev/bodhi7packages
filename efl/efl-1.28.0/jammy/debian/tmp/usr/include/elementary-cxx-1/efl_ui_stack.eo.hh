#ifndef EFL_UI_STACK_EO_HH
#define EFL_UI_STACK_EO_HH
#include <Eo.h>
...
#ifndef EFL_UI_STACK_FWD_GUARD
#define EFL_UI_STACK_FWD_GUARD
namespace efl { namespace ui { 
struct Stack;
} } 
namespace efl { namespace eo { template<> struct is_eolian_object< ::efl::ui::Stack> : ::std::true_type {}; } }
namespace efl { namespace eo { template<> struct is_eolian_object< ::efl::ui::Stack&> : ::std::true_type {}; } }
namespace efl { namespace eo { template<> struct is_eolian_object< ::efl::ui::Stack const> : ::std::true_type {}; } }
namespace efl { namespace eo { template<> struct is_eolian_object< ::efl::ui::Stack const&> : ::std::true_type {}; } }
#endif
...
struct Stack {
    ...
    {
        return EFL_UI_STACK_CLASS;
    }
    Eo* _eo_ptr() const { return *(reinterpret_cast<Eo **>(const_cast<Stack *>(this))); }
    operator ::efl::ui::Stack() const;
    operator ::efl::ui::Stack&();
    operator ::efl::ui::Stack const&() const;
    /// @cond LOCAL
     ::efl::eolian::address_of_operator<Stack,  ::efl::Container,  ::efl::Loop_Consumer,  ::efl::Object,  ::efl::Pack,  ::efl::Pack_Linear,  ::efl::Part,  ::efl::access::Component,  ::efl::access::Object,  ::efl::canvas::Group,  ::efl::canvas::Object,  ::efl::canvas::Object_Animation,  ::efl::canvas::Pointer,  ::efl::gfx::Color,  ::efl::gfx::Entity,  ::efl::gfx::Filter,  ::efl::gfx::Hint,  ::efl::gfx::Mapping,  ::efl::gfx::Stack,  ::efl::input::Interface,  ::efl::ui::Dnd,  ::efl::ui::I18n,  ::efl::ui::L10n,  ::efl::ui::Property_Bind,  ::efl::ui::Selection,  ::efl::ui::View,  ::efl::ui::Widget,  ::efl::ui::focus::Object,  ::efl::ui::spotlight::Container> operator&() { return {this}; }
     ::efl::eolian::address_of_operator<Stack const ,  ::efl::Container const ,  ::efl::Loop_Consumer const ,  ::efl::Object const ,  ::efl::Pack const ,  ::efl::Pack_Linear const ,  ::efl::Part const ,  ::efl::access::Component const ,  ::efl::access::Object const ,  ::efl::canvas::Group const ,  ::efl::canvas::Object const ,  ::efl::canvas::Object_Animation const ,  ::efl::canvas::Pointer const ,  ::efl::gfx::Color const ,  ::efl::gfx::Entity const ,  ::efl::gfx::Filter const ,  ::efl::gfx::Hint const ,  ::efl::gfx::Mapping const ,  ::efl::gfx::Stack const ,  ::efl::input::Interface const ,  ::efl::ui::Dnd const ,  ::efl::ui::I18n const ,  ::efl::ui::L10n const ,  ::efl::ui::Property_Bind const ,  ::efl::ui::Selection const ,  ::efl::ui::View const ,  ::efl::ui::Widget const ,  ::efl::ui::focus::Object const ,  ::efl::ui::spotlight::Container const > operator&() const { return {this}; }
    /// @endcond
};
} } 
}
    ...
    , EO_CXX_INHERIT(::efl::ui::spotlight::Container)
{
    ...
    Stack( ::efl::eo::instantiate_t)
    {
        ::efl::eolian::do_eo_add( ::efl::eo::concrete::_eo_raw, ::efl::eo::concrete{nullptr}, _eo_class());
    }
    template <typename T>
    explicit Stack( ::efl::eo::instantiate_t, T&& parent, typename std::enable_if< ::efl::eo::is_eolian_object<T>::value>::type* = 0)
    {
        ::efl::eolian::do_eo_add( ::efl::eo::concrete::_eo_raw, parent, _eo_class());
    }
    template <typename F> Stack( ::efl::eo::instantiate_t, F&& f, typename ::std::enable_if< ::efl::eolian::is_constructor_lambda<F, Stack >::value>::type* = 0)
    {
        ::efl::eolian::do_eo_add( ::efl::eo::concrete::_eo_raw, ::efl::eo::concrete{nullptr}, _eo_class(), *this, std::forward<F>(f));
    }
    template <typename T, typename F> Stack(  ::efl::eo::instantiate_t, T&& parent, F&& f, typename ::std::enable_if< ::efl::eolian::is_constructor_lambda<F, Stack >::value && ::efl::eo::is_eolian_object<T>::value>::type* = 0)
    {
