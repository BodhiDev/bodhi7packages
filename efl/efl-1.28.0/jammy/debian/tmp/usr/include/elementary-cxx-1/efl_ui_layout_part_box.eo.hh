#ifndef EFL_UI_LAYOUT_PART_BOX_EO_HH
#define EFL_UI_LAYOUT_PART_BOX_EO_HH
#include <Eo.h>
...
#ifndef EFL_UI_LAYOUT_PART_BOX_FWD_GUARD
#define EFL_UI_LAYOUT_PART_BOX_FWD_GUARD
namespace efl { namespace ui { 
struct Layout_Part_Box;
} } 
namespace efl { namespace eo { template<> struct is_eolian_object< ::efl::ui::Layout_Part_Box> : ::std::true_type {}; } }
namespace efl { namespace eo { template<> struct is_eolian_object< ::efl::ui::Layout_Part_Box&> : ::std::true_type {}; } }
namespace efl { namespace eo { template<> struct is_eolian_object< ::efl::ui::Layout_Part_Box const> : ::std::true_type {}; } }
namespace efl { namespace eo { template<> struct is_eolian_object< ::efl::ui::Layout_Part_Box const&> : ::std::true_type {}; } }
#endif
...
struct Layout_Part_Box {
    ...
    {
        return EFL_UI_LAYOUT_PART_BOX_CLASS;
    }
    Eo* _eo_ptr() const { return *(reinterpret_cast<Eo **>(const_cast<Layout_Part_Box *>(this))); }
    operator ::efl::ui::Layout_Part_Box() const;
    operator ::efl::ui::Layout_Part_Box&();
    operator ::efl::ui::Layout_Part_Box const&() const;
    /// @cond LOCAL
     ::efl::eolian::address_of_operator<Layout_Part_Box,  ::efl::Container,  ::efl::Object,  ::efl::Pack,  ::efl::Pack_Linear,  ::efl::ui::Layout_Orientable,  ::efl::ui::Layout_Orientable_Readonly> operator&() { return {this}; }
     ::efl::eolian::address_of_operator<Layout_Part_Box const ,  ::efl::Container const ,  ::efl::Object const ,  ::efl::Pack const ,  ::efl::Pack_Linear const ,  ::efl::ui::Layout_Orientable const ,  ::efl::ui::Layout_Orientable_Readonly const > operator&() const { return {this}; }
    /// @endcond
};
} } 
}
