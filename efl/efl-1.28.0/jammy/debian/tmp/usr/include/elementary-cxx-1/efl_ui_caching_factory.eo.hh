#ifndef EFL_UI_CACHING_FACTORY_EO_HH
#define EFL_UI_CACHING_FACTORY_EO_HH
#include <Eo.h>
...
namespace efl { namespace ui { 
struct Caching_Factory {
    ::efl::eolian::return_traits< unsigned int>::type memory_limit_get() const;
    ::efl::eolian::return_traits<void>::type memory_limit_set( ::efl::eolian::in_traits< unsigned int>::type limit) const;
    ::efl::eolian::return_traits< unsigned int>::type items_limit_get() const;
    ::efl::eolian::return_traits<void>::type items_limit_set( ::efl::eolian::in_traits< unsigned int>::type limit) const;
    static Efl_Class const* _eo_class()
    {
        return EFL_UI_CACHING_FACTORY_CLASS;
    }
    Eo* _eo_ptr() const { return *(reinterpret_cast<Eo **>(const_cast<Caching_Factory *>(this))); }
    operator ::efl::ui::Caching_Factory() const;
    operator ::efl::ui::Caching_Factory&();
    operator ::efl::ui::Caching_Factory const&() const;
    /// @cond LOCAL
     ::efl::eolian::address_of_operator<Caching_Factory,  ::efl::Loop_Consumer,  ::efl::Object,  ::efl::Part,  ::efl::ui::Factory,  ::efl::ui::Factory_Bind,  ::efl::ui::Property_Bind,  ::efl::ui::Widget_Factory> operator&() { return {this}; }
     ::efl::eolian::address_of_operator<Caching_Factory const ,  ::efl::Loop_Consumer const ,  ::efl::Object const ,  ::efl::Part const ,  ::efl::ui::Factory const ,  ::efl::ui::Factory_Bind const ,  ::efl::ui::Property_Bind const ,  ::efl::ui::Widget_Factory const > operator&() const { return {this}; }
    /// @endcond
};
} } 
}
namespace efl { namespace ui { 
struct Caching_Factory : private ::efl::eo::concrete
...
{
    explicit Caching_Factory( ::Eo* eo)
        : ::efl::eo::concrete(eo) {}
    Caching_Factory(std::nullptr_t)
        : ::efl::eo::concrete(nullptr) {}
    explicit Caching_Factory() = default;
    Caching_Factory(Caching_Factory const&) = default;
    Caching_Factory(Caching_Factory&&) = default;
    Caching_Factory& operator=(Caching_Factory const&) = default;
    Caching_Factory& operator=(Caching_Factory&&) = default;
    template <typename Derived>
    Caching_Factory(Derived&& derived
        , typename std::enable_if<
            ::efl::eo::is_eolian_object<Derived>::value
             && std::is_base_of< Caching_Factory, Derived>::value>::type* = 0)
            : ::efl::eo::concrete(derived._eo_ptr()) {}

    Caching_Factory( ::efl::eo::instantiate_t)
    {
        ::efl::eolian::do_eo_add( ::efl::eo::concrete::_eo_raw, ::efl::eo::concrete{nullptr}, _eo_class());
    }
    template <typename T>
    explicit Caching_Factory( ::efl::eo::instantiate_t, T&& parent, typename std::enable_if< ::efl::eo::is_eolian_object<T>::value>::type* = 0)
    {
        ::efl::eolian::do_eo_add( ::efl::eo::concrete::_eo_raw, parent, _eo_class());
    }
    template <typename F> Caching_Factory( ::efl::eo::instantiate_t, F&& f, typename ::std::enable_if< ::efl::eolian::is_constructor_lambda<F, Caching_Factory >::value>::type* = 0)
    {
        ::efl::eolian::do_eo_add( ::efl::eo::concrete::_eo_raw, ::efl::eo::concrete{nullptr}, _eo_class(), *this, std::forward<F>(f));
    }
    template <typename T, typename F> Caching_Factory(  ::efl::eo::instantiate_t, T&& parent, F&& f, typename ::std::enable_if< ::efl::eolian::is_constructor_lambda<F, Caching_Factory >::value && ::efl::eo::is_eolian_object<T>::value>::type* = 0)
    {
    ...
    /// @cond LOCAL
     ...
     ::efl::eolian::address_of_operator<Caching_Factory const ,  ::efl::Loop_Consumer const ,  ::efl::Object const ,  ::efl::Part const ,  ::efl::ui::Factory const ,  ::efl::ui::Factory_Bind const ,  ::efl::ui::Property_Bind const ,  ::efl::ui::Widget_Factory const > operator&() const { return {this}; }
    /// @endcond
    ::efl::eo::wref<Caching_Factory> _get_wref() const { return ::efl::eo::wref<Caching_Factory>(*this); }
    ...
    const Caching_Factory* operator->() const { return this; }
    Caching_Factory* operator->() { return this; }
    operator Eo*() const { return _eo_ptr(); }
#endif 
    friend bool operator==(Caching_Factory const& lhs, Caching_Factory const& rhs)
    { return lhs._get_concrete() == rhs._get_concrete(); }
    friend bool operator!=(Caching_Factory const& lhs, Caching_Factory const& rhs)
    { return !(lhs == rhs); }
};
static_assert(sizeof(Caching_Factory) == sizeof(Eo*), "");
static_assert(std::is_standard_layout<Caching_Factory>::value, "");
} } 
