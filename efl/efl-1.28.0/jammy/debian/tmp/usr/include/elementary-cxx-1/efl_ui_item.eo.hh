#ifndef EFL_UI_ITEM_EO_HH
#define EFL_UI_ITEM_EO_HH
#include <Eo.h>
...
namespace efl { namespace ui { 
struct Item {
    ::efl::eolian::return_traits<int>::type index_get() const;
    ::efl::eolian::return_traits< ::efl::ui::Widget>::type container_get() const;
    ::efl::eolian::return_traits<void>::type container_set( ::efl::eolian::in_traits< ::efl::ui::Widget>::type container) const;
    ::efl::eolian::return_traits< ::efl::ui::Item>::type item_parent_get() const;
    ::efl::eolian::return_traits<void>::type item_parent_set( ::efl::eolian::in_traits< ::efl::ui::Item>::type parent) const;
    ::efl::eolian::return_traits<bool>::type calc_locked_get() const;
    ::efl::eolian::return_traits<void>::type calc_locked_set( ::efl::eolian::in_traits<bool>::type locked) const;
    static Efl_Class const* _eo_class()
    {
        return EFL_UI_ITEM_CLASS;
    }
    Eo* _eo_ptr() const { return *(reinterpret_cast<Eo **>(const_cast<Item *>(this))); }
    operator ::efl::ui::Item() const;
    operator ::efl::ui::Item&();
    operator ::efl::ui::Item const&() const;
    /// @cond LOCAL
     ::efl::eolian::address_of_operator<Item,  ::efl::Container,  ::efl::Loop_Consumer,  ::efl::Object,  ::efl::Part,  ::efl::access::Component,  ::efl::access::Object,  ::efl::canvas::Group,  ::efl::canvas::Object,  ::efl::canvas::Object_Animation,  ::efl::canvas::Pointer,  ::efl::gfx::Color,  ::efl::gfx::Entity,  ::efl::gfx::Filter,  ::efl::gfx::Hint,  ::efl::gfx::Mapping,  ::efl::gfx::Stack,  ::efl::input::Clickable,  ::efl::input::Interface,  ::efl::layout::Calc,  ::efl::layout::Group,  ::efl::layout::Signal,  ::efl::ui::Dnd,  ::efl::ui::Factory_Bind,  ::efl::ui::I18n,  ::efl::ui::L10n,  ::efl::ui::Layout_Base,  ::efl::ui::Property_Bind,  ::efl::ui::Selectable,  ::efl::ui::Selection,  ::efl::ui::View,  ::efl::ui::Widget,  ::efl::ui::focus::Object> operator&() { return {this}; }
     ::efl::eolian::address_of_operator<Item const ,  ::efl::Container const ,  ::efl::Loop_Consumer const ,  ::efl::Object const ,  ::efl::Part const ,  ::efl::access::Component const ,  ::efl::access::Object const ,  ::efl::canvas::Group const ,  ::efl::canvas::Object const ,  ::efl::canvas::Object_Animation const ,  ::efl::canvas::Pointer const ,  ::efl::gfx::Color const ,  ::efl::gfx::Entity const ,  ::efl::gfx::Filter const ,  ::efl::gfx::Hint const ,  ::efl::gfx::Mapping const ,  ::efl::gfx::Stack const ,  ::efl::input::Clickable const ,  ::efl::input::Interface const ,  ::efl::layout::Calc const ,  ::efl::layout::Group const ,  ::efl::layout::Signal const ,  ::efl::ui::Dnd const ,  ::efl::ui::Factory_Bind const ,  ::efl::ui::I18n const ,  ::efl::ui::L10n const ,  ::efl::ui::Layout_Base const ,  ::efl::ui::Property_Bind const ,  ::efl::ui::Selectable const ,  ::efl::ui::Selection const ,  ::efl::ui::View const ,  ::efl::ui::Widget const ,  ::efl::ui::focus::Object const > operator&() const { return {this}; }
    /// @endcond
};
} } 
}
