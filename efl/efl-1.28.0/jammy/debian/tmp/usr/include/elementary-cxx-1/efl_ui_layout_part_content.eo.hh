#ifndef EFL_UI_LAYOUT_PART_CONTENT_EO_HH
#define EFL_UI_LAYOUT_PART_CONTENT_EO_HH
#include <Eo.h>
...
struct Layout_Part_Content {
    ...
    {
        return EFL_UI_LAYOUT_PART_CONTENT_CLASS;
    }
    Eo* _eo_ptr() const { return *(reinterpret_cast<Eo **>(const_cast<Layout_Part_Content *>(this))); }
    operator ::efl::ui::Layout_Part_Content() const;
    operator ::efl::ui::Layout_Part_Content&();
    operator ::efl::ui::Layout_Part_Content const&() const;
    /// @cond LOCAL
     ::efl::eolian::address_of_operator<Layout_Part_Content,  ::efl::Content,  ::efl::Object,  ::efl::canvas::Layout_Part_Type_Provider,  ::efl::gfx::Entity,  ::efl::ui::Layout_Part,  ::efl::ui::Property_Bind,  ::efl::ui::Widget_Part> operator&() { return {this}; }
     ::efl::eolian::address_of_operator<Layout_Part_Content const ,  ::efl::Content const ,  ::efl::Object const ,  ::efl::canvas::Layout_Part_Type_Provider const ,  ::efl::gfx::Entity const ,  ::efl::ui::Layout_Part const ,  ::efl::ui::Property_Bind const ,  ::efl::ui::Widget_Part const > operator&() const { return {this}; }
    /// @endcond
};
} } 
}
namespace efl { namespace ui { 
struct Layout_Part_Content : private ::efl::eo::concrete
...
{
    explicit Layout_Part_Content( ::Eo* eo)
        : ::efl::eo::concrete(eo) {}
    Layout_Part_Content(std::nullptr_t)
        : ::efl::eo::concrete(nullptr) {}
    explicit Layout_Part_Content() = default;
    Layout_Part_Content(Layout_Part_Content const&) = default;
    Layout_Part_Content(Layout_Part_Content&&) = default;
    Layout_Part_Content& operator=(Layout_Part_Content const&) = default;
    Layout_Part_Content& operator=(Layout_Part_Content&&) = default;
    template <typename Derived>
    Layout_Part_Content(Derived&& derived
        , typename std::enable_if<
            ::efl::eo::is_eolian_object<Derived>::value
             && std::is_base_of< Layout_Part_Content, Derived>::value>::type* = 0)
            : ::efl::eo::concrete(derived._eo_ptr()) {}

    Layout_Part_Content( ::efl::eo::instantiate_t)
    {
        ::efl::eolian::do_eo_add( ::efl::eo::concrete::_eo_raw, ::efl::eo::concrete{nullptr}, _eo_class());
    }
    template <typename T>
    explicit Layout_Part_Content( ::efl::eo::instantiate_t, T&& parent, typename std::enable_if< ::efl::eo::is_eolian_object<T>::value>::type* = 0)
    {
        ::efl::eolian::do_eo_add( ::efl::eo::concrete::_eo_raw, parent, _eo_class());
    }
    template <typename F> Layout_Part_Content( ::efl::eo::instantiate_t, F&& f, typename ::std::enable_if< ::efl::eolian::is_constructor_lambda<F, Layout_Part_Content >::value>::type* = 0)
    {
        ::efl::eolian::do_eo_add( ::efl::eo::concrete::_eo_raw, ::efl::eo::concrete{nullptr}, _eo_class(), *this, std::forward<F>(f));
    }
    template <typename T, typename F> Layout_Part_Content(  ::efl::eo::instantiate_t, T&& parent, F&& f, typename ::std::enable_if< ::efl::eolian::is_constructor_lambda<F, Layout_Part_Content >::value && ::efl::eo::is_eolian_object<T>::value>::type* = 0)
    {
    ...
    /// @cond LOCAL
     ...
     ::efl::eolian::address_of_operator<Layout_Part_Content const ,  ::efl::Content const ,  ::efl::Object const ,  ::efl::canvas::Layout_Part_Type_Provider const ,  ::efl::gfx::Entity const ,  ::efl::ui::Layout_Part const ,  ::efl::ui::Property_Bind const ,  ::efl::ui::Widget_Part const > operator&() const { return {this}; }
    /// @endcond
    ::efl::eo::wref<Layout_Part_Content> _get_wref() const { return ::efl::eo::wref<Layout_Part_Content>(*this); }
    ...
    const Layout_Part_Content* operator->() const { return this; }
    Layout_Part_Content* operator->() { return this; }
    operator Eo*() const { return _eo_ptr(); }
#endif 
    friend bool operator==(Layout_Part_Content const& lhs, Layout_Part_Content const& rhs)
    { return lhs._get_concrete() == rhs._get_concrete(); }
    friend bool operator!=(Layout_Part_Content const& lhs, Layout_Part_Content const& rhs)
    { return !(lhs == rhs); }
};
static_assert(sizeof(Layout_Part_Content) == sizeof(Eo*), "");
static_assert(std::is_standard_layout<Layout_Part_Content>::value, "");
} } 
