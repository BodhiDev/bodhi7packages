#ifndef EFL_UI_LAYOUT_BASE_EO_HH
#define EFL_UI_LAYOUT_BASE_EO_HH
#include <Eo.h>
...
namespace efl { namespace ui { 
struct Layout_Base {
    ::efl::eolian::return_traits<void>::type finger_size_multiplier_get( ::efl::eolian::out_traits< unsigned int>::type multiplier_x,  ::efl::eolian::out_traits< unsigned int>::type multiplier_y) const;
    ::efl::eolian::return_traits<void>::type finger_size_multiplier_set( ::efl::eolian::in_traits< unsigned int>::type multiplier_x,  ::efl::eolian::in_traits< unsigned int>::type multiplier_y) const;
    ::efl::eolian::return_traits<void>::type theme_get( ::efl::eolian::out_traits< ::efl::eina::string_view>::type klass,  ::efl::eolian::out_traits< ::efl::eina::string_view>::type group,  ::efl::eolian::out_traits< ::efl::eina::string_view>::type style) const;
    ::efl::eolian::return_traits<Eina_Error>::type theme_set( ::efl::eolian::in_traits< ::efl::eina::string_view>::type klass,  ::efl::eolian::in_traits< ::efl::eina::string_view>::type group,  ::efl::eolian::in_traits< ::efl::eina::string_view>::type style) const;
#ifdef EFL_BETA_API_SUPPORT
    ::efl::eolian::return_traits<bool>::type automatic_theme_rotation_get() const;
#endif
#ifdef EFL_BETA_API_SUPPORT
    ::efl::eolian::return_traits<void>::type automatic_theme_rotation_set( ::efl::eolian::in_traits<bool>::type automatic) const;
#endif
    ::efl::eolian::return_traits<int>::type theme_version_get() const;
#ifdef EFL_BETA_API_SUPPORT
    ::efl::eolian::return_traits<void>::type theme_rotation_apply( ::efl::eolian::in_traits<int>::type orientation) const;
#endif
    static Efl_Class const* _eo_class()
    {
        return EFL_UI_LAYOUT_BASE_CLASS;
    }
    Eo* _eo_ptr() const { return *(reinterpret_cast<Eo **>(const_cast<Layout_Base *>(this))); }
    operator ::efl::ui::Layout_Base() const;
    operator ::efl::ui::Layout_Base&();
    operator ::efl::ui::Layout_Base const&() const;
    /// @cond LOCAL
     ::efl::eolian::address_of_operator<Layout_Base,  ::efl::Container,  ::efl::Loop_Consumer,  ::efl::Object,  ::efl::Part,  ::efl::access::Component,  ::efl::access::Object,  ::efl::canvas::Group,  ::efl::canvas::Object,  ::efl::canvas::Object_Animation,  ::efl::canvas::Pointer,  ::efl::gfx::Color,  ::efl::gfx::Entity,  ::efl::gfx::Filter,  ::efl::gfx::Hint,  ::efl::gfx::Mapping,  ::efl::gfx::Stack,  ::efl::input::Interface,  ::efl::layout::Calc,  ::efl::layout::Group,  ::efl::layout::Signal,  ::efl::ui::Dnd,  ::efl::ui::Factory_Bind,  ::efl::ui::I18n,  ::efl::ui::L10n,  ::efl::ui::Property_Bind,  ::efl::ui::Selection,  ::efl::ui::View,  ::efl::ui::Widget,  ::efl::ui::focus::Object> operator&() { return {this}; }
     ::efl::eolian::address_of_operator<Layout_Base const ,  ::efl::Container const ,  ::efl::Loop_Consumer const ,  ::efl::Object const ,  ::efl::Part const ,  ::efl::access::Component const ,  ::efl::access::Object const ,  ::efl::canvas::Group const ,  ::efl::canvas::Object const ,  ::efl::canvas::Object_Animation const ,  ::efl::canvas::Pointer const ,  ::efl::gfx::Color const ,  ::efl::gfx::Entity const ,  ::efl::gfx::Filter const ,  ::efl::gfx::Hint const ,  ::efl::gfx::Mapping const ,  ::efl::gfx::Stack const ,  ::efl::input::Interface const ,  ::efl::layout::Calc const ,  ::efl::layout::Group const ,  ::efl::layout::Signal const ,  ::efl::ui::Dnd const ,  ::efl::ui::Factory_Bind const ,  ::efl::ui::I18n const ,  ::efl::ui::L10n const ,  ::efl::ui::Property_Bind const ,  ::efl::ui::Selection const ,  ::efl::ui::View const ,  ::efl::ui::Widget const ,  ::efl::ui::focus::Object const > operator&() const { return {this}; }
    /// @endcond
};
} } 
}
namespace efl { namespace ui { 
struct Layout_Base : private ::efl::eo::concrete
...
{
    explicit Layout_Base( ::Eo* eo)
        : ::efl::eo::concrete(eo) {}
    Layout_Base(std::nullptr_t)
        : ::efl::eo::concrete(nullptr) {}
    explicit Layout_Base() = default;
    Layout_Base(Layout_Base const&) = default;
    Layout_Base(Layout_Base&&) = default;
    Layout_Base& operator=(Layout_Base const&) = default;
    Layout_Base& operator=(Layout_Base&&) = default;
    template <typename Derived>
    Layout_Base(Derived&& derived
        , typename std::enable_if<
            ::efl::eo::is_eolian_object<Derived>::value
             && std::is_base_of< Layout_Base, Derived>::value>::type* = 0)
    ...
    static struct theme_changed_event
    {
        ...
        { return EFL_UI_LAYOUT_EVENT_THEME_CHANGED; }
    ...
    /// @cond LOCAL
     ...
     ::efl::eolian::address_of_operator<Layout_Base const ,  ::efl::Container const ,  ::efl::Loop_Consumer const ,  ::efl::Object const ,  ::efl::Part const ,  ::efl::access::Component const ,  ::efl::access::Object const ,  ::efl::canvas::Group const ,  ::efl::canvas::Object const ,  ::efl::canvas::Object_Animation const ,  ::efl::canvas::Pointer const ,  ::efl::gfx::Color const ,  ::efl::gfx::Entity const ,  ::efl::gfx::Filter const ,  ::efl::gfx::Hint const ,  ::efl::gfx::Mapping const ,  ::efl::gfx::Stack const ,  ::efl::input::Interface const ,  ::efl::layout::Calc const ,  ::efl::layout::Group const ,  ::efl::layout::Signal const ,  ::efl::ui::Dnd const ,  ::efl::ui::Factory_Bind const ,  ::efl::ui::I18n const ,  ::efl::ui::L10n const ,  ::efl::ui::Property_Bind const ,  ::efl::ui::Selection const ,  ::efl::ui::View const ,  ::efl::ui::Widget const ,  ::efl::ui::focus::Object const > operator&() const { return {this}; }
    /// @endcond
    ::efl::eo::wref<Layout_Base> _get_wref() const { return ::efl::eo::wref<Layout_Base>(*this); }
...
#ifdef EFL_CXXPERIMENTAL
    const Layout_Base* operator->() const { return this; }
    Layout_Base* operator->() { return this; }
    operator Eo*() const { return _eo_ptr(); }
#endif 
    friend bool operator==(Layout_Base const& lhs, Layout_Base const& rhs)
    { return lhs._get_concrete() == rhs._get_concrete(); }
    friend bool operator!=(Layout_Base const& lhs, Layout_Base const& rhs)
    { return !(lhs == rhs); }
};
static_assert(sizeof(Layout_Base) == sizeof(Eo*), "");
static_assert(std::is_standard_layout<Layout_Base>::value, "");
} } 
