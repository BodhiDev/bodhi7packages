#ifndef EFL_UI_IMAGE_ZOOMABLE_EO_HH
#define EFL_UI_IMAGE_ZOOMABLE_EO_HH
#include <Eo.h>
...
#ifndef EFL_UI_IMAGE_ZOOMABLE_FWD_GUARD
#define EFL_UI_IMAGE_ZOOMABLE_FWD_GUARD
namespace efl { namespace ui { 
struct Image_Zoomable;
} } 
namespace efl { namespace eo { template<> struct is_eolian_object< ::efl::ui::Image_Zoomable> : ::std::true_type {}; } }
namespace efl { namespace eo { template<> struct is_eolian_object< ::efl::ui::Image_Zoomable&> : ::std::true_type {}; } }
namespace efl { namespace eo { template<> struct is_eolian_object< ::efl::ui::Image_Zoomable const> : ::std::true_type {}; } }
namespace efl { namespace eo { template<> struct is_eolian_object< ::efl::ui::Image_Zoomable const&> : ::std::true_type {}; } }
#endif
...
namespace efl { namespace ui { 
struct Image_Zoomable {
    ::efl::eolian::return_traits<bool>::type gesture_enabled_get() const;
    ::efl::eolian::return_traits<void>::type gesture_enabled_set( ::efl::eolian::in_traits<bool>::type gesture) const;
    ::efl::eolian::return_traits<Eina_Rect>::type image_region_get() const;
    ::efl::eolian::return_traits<void>::type image_region_set( ::efl::eolian::in_traits<Eina_Rect>::type region) const;
    static Efl_Class const* _eo_class()
    {
        return EFL_UI_IMAGE_ZOOMABLE_CLASS;
    }
    Eo* _eo_ptr() const { return *(reinterpret_cast<Eo **>(const_cast<Image_Zoomable *>(this))); }
    operator ::efl::ui::Image_Zoomable() const;
    operator ::efl::ui::Image_Zoomable&();
    operator ::efl::ui::Image_Zoomable const&() const;
    /// @cond LOCAL
     ::efl::eolian::address_of_operator<Image_Zoomable,  ::efl::File,  ::efl::Loop_Consumer,  ::efl::Object,  ::efl::Part,  ::efl::Playable,  ::efl::Player,  ::efl::access::Action,  ::efl::access::Component,  ::efl::access::Object,  ::efl::access::widget::Action,  ::efl::canvas::Group,  ::efl::canvas::Object,  ::efl::canvas::Object_Animation,  ::efl::canvas::Pointer,  ::efl::gfx::Arrangement,  ::efl::gfx::Color,  ::efl::gfx::Entity,  ::efl::gfx::Filter,  ::efl::gfx::Hint,  ::efl::gfx::Image,  ::efl::gfx::Image_Load_Controller,  ::efl::gfx::Image_Orientable,  ::efl::gfx::Mapping,  ::efl::gfx::Stack,  ::efl::gfx::View,  ::efl::input::Clickable,  ::efl::input::Interface,  ::efl::layout::Calc,  ::efl::layout::Group,  ::efl::layout::Signal,  ::efl::ui::Dnd,  ::efl::ui::Draggable,  ::efl::ui::I18n,  ::efl::ui::Image,  ::efl::ui::L10n,  ::efl::ui::Property_Bind,  ::efl::ui::Scrollable,  ::efl::ui::Scrollbar,  ::efl::ui::Selection,  ::efl::ui::View,  ::efl::ui::Widget,  ::efl::ui::Zoom,  ::efl::ui::focus::Object> operator&() { return {this}; }
     ::efl::eolian::address_of_operator<Image_Zoomable const ,  ::efl::File const ,  ::efl::Loop_Consumer const ,  ::efl::Object const ,  ::efl::Part const ,  ::efl::Playable const ,  ::efl::Player const ,  ::efl::access::Action const ,  ::efl::access::Component const ,  ::efl::access::Object const ,  ::efl::access::widget::Action const ,  ::efl::canvas::Group const ,  ::efl::canvas::Object const ,  ::efl::canvas::Object_Animation const ,  ::efl::canvas::Pointer const ,  ::efl::gfx::Arrangement const ,  ::efl::gfx::Color const ,  ::efl::gfx::Entity const ,  ::efl::gfx::Filter const ,  ::efl::gfx::Hint const ,  ::efl::gfx::Image const ,  ::efl::gfx::Image_Load_Controller const ,  ::efl::gfx::Image_Orientable const ,  ::efl::gfx::Mapping const ,  ::efl::gfx::Stack const ,  ::efl::gfx::View const ,  ::efl::input::Clickable const ,  ::efl::input::Interface const ,  ::efl::layout::Calc const ,  ::efl::layout::Group const ,  ::efl::layout::Signal const ,  ::efl::ui::Dnd const ,  ::efl::ui::Draggable const ,  ::efl::ui::I18n const ,  ::efl::ui::Image const ,  ::efl::ui::L10n const ,  ::efl::ui::Property_Bind const ,  ::efl::ui::Scrollable const ,  ::efl::ui::Scrollbar const ,  ::efl::ui::Selection const ,  ::efl::ui::View const ,  ::efl::ui::Widget const ,  ::efl::ui::Zoom const ,  ::efl::ui::focus::Object const > operator&() const { return {this}; }
    /// @endcond
};
} } 
}
namespace efl { namespace ui { 
struct Image_Zoomable : private ::efl::eo::concrete
    ...
    , EO_CXX_INHERIT(::efl::ui::Zoom)
    , EO_CXX_INHERIT(::efl::ui::focus::Object)
{
    explicit Image_Zoomable( ::Eo* eo)
        : ::efl::eo::concrete(eo) {}
    Image_Zoomable(std::nullptr_t)
        : ::efl::eo::concrete(nullptr) {}
    explicit Image_Zoomable() = default;
    Image_Zoomable(Image_Zoomable const&) = default;
    Image_Zoomable(Image_Zoomable&&) = default;
    Image_Zoomable& operator=(Image_Zoomable const&) = default;
    Image_Zoomable& operator=(Image_Zoomable&&) = default;
    template <typename Derived>
    Image_Zoomable(Derived&& derived
        , typename std::enable_if<
            ::efl::eo::is_eolian_object<Derived>::value
             && std::is_base_of< Image_Zoomable, Derived>::value>::type* = 0)
            : ::efl::eo::concrete(derived._eo_ptr()) {}

    Image_Zoomable( ::efl::eo::instantiate_t)
    {
        ::efl::eolian::do_eo_add( ::efl::eo::concrete::_eo_raw, ::efl::eo::concrete{nullptr}, _eo_class());
    }
    template <typename T>
    explicit Image_Zoomable( ::efl::eo::instantiate_t, T&& parent, typename std::enable_if< ::efl::eo::is_eolian_object<T>::value>::type* = 0)
    {
        ::efl::eolian::do_eo_add( ::efl::eo::concrete::_eo_raw, parent, _eo_class());
    }
    template <typename F> Image_Zoomable( ::efl::eo::instantiate_t, F&& f, typename ::std::enable_if< ::efl::eolian::is_constructor_lambda<F, Image_Zoomable >::value>::type* = 0)
    {
        ::efl::eolian::do_eo_add( ::efl::eo::concrete::_eo_raw, ::efl::eo::concrete{nullptr}, _eo_class(), *this, std::forward<F>(f));
    }
    template <typename T, typename F> Image_Zoomable(  ::efl::eo::instantiate_t, T&& parent, F&& f, typename ::std::enable_if< ::efl::eolian::is_constructor_lambda<F, Image_Zoomable >::value && ::efl::eo::is_eolian_object<T>::value>::type* = 0)
    {
    ...
    Eo* _eo_ptr() const { return *(reinterpret_cast<Eo **>(const_cast<Image_Zoomable *>(this))); }
    static struct press_event
    {
        static Efl_Event_Description const* description()
        { return EFL_UI_IMAGE_ZOOMABLE_EVENT_PRESS; }
        typedef void parameter_type;
    } const press_event;
#ifdef EFL_CXXPERIMENTAL
    template <typename F>
    typename std::enable_if<std::is_bind_expression<F>::value, ::efl::eolian::signal_connection>::type
    press_event_cb_add(F function)
    {
        return ::efl::eolian::event_add(press_event, *this, function);
    }
    template <typename F>
    typename std::enable_if<!std::is_bind_expression<F>::value, ::efl::eolian::signal_connection>::type
    press_event_cb_add(F function)
    {
        return ::efl::eolian::event_add(press_event, *this, std::bind(function));
    }
#endif
    static struct load_event
    {
        static Efl_Event_Description const* description()
        { return EFL_UI_IMAGE_ZOOMABLE_EVENT_LOAD; }
        typedef void parameter_type;
    } const load_event;
#ifdef EFL_CXXPERIMENTAL
    template <typename F>
    typename std::enable_if<std::is_bind_expression<F>::value, ::efl::eolian::signal_connection>::type
    load_event_cb_add(F function)
    {
        return ::efl::eolian::event_add(load_event, *this, function);
    }
    template <typename F>
    typename std::enable_if<!std::is_bind_expression<F>::value, ::efl::eolian::signal_connection>::type
    load_event_cb_add(F function)
    {
        return ::efl::eolian::event_add(load_event, *this, std::bind(function));
    }
#endif
    static struct loaded_event
    {
        static Efl_Event_Description const* description()
        { return EFL_UI_IMAGE_ZOOMABLE_EVENT_LOADED; }
        typedef void parameter_type;
    } const loaded_event;
#ifdef EFL_CXXPERIMENTAL
    template <typename F>
    typename std::enable_if<std::is_bind_expression<F>::value, ::efl::eolian::signal_connection>::type
    loaded_event_cb_add(F function)
    {
        return ::efl::eolian::event_add(loaded_event, *this, function);
    }
    template <typename F>
    typename std::enable_if<!std::is_bind_expression<F>::value, ::efl::eolian::signal_connection>::type
    loaded_event_cb_add(F function)
    {
        return ::efl::eolian::event_add(loaded_event, *this, std::bind(function));
    }
#endif
    static struct load_detail_event
    {
        static Efl_Event_Description const* description()
        { return EFL_UI_IMAGE_ZOOMABLE_EVENT_LOAD_DETAIL; }
        typedef void parameter_type;
    } const load_detail_event;
#ifdef EFL_CXXPERIMENTAL
    template <typename F>
    typename std::enable_if<std::is_bind_expression<F>::value, ::efl::eolian::signal_connection>::type
    load_detail_event_cb_add(F function)
    {
        return ::efl::eolian::event_add(load_detail_event, *this, function);
    }
    template <typename F>
    typename std::enable_if<!std::is_bind_expression<F>::value, ::efl::eolian::signal_connection>::type
    load_detail_event_cb_add(F function)
    {
        return ::efl::eolian::event_add(load_detail_event, *this, std::bind(function));
    }
#endif
    static struct loaded_detail_event
    {
        static Efl_Event_Description const* description()
        { return EFL_UI_IMAGE_ZOOMABLE_EVENT_LOADED_DETAIL; }
        typedef void parameter_type;
    } const loaded_detail_event;
#ifdef EFL_CXXPERIMENTAL
    template <typename F>
    typename std::enable_if<std::is_bind_expression<F>::value, ::efl::eolian::signal_connection>::type
    loaded_detail_event_cb_add(F function)
    {
        return ::efl::eolian::event_add(loaded_detail_event, *this, function);
    }
    template <typename F>
    typename std::enable_if<!std::is_bind_expression<F>::value, ::efl::eolian::signal_connection>::type
    loaded_detail_event_cb_add(F function)
    {
        return ::efl::eolian::event_add(loaded_detail_event, *this, std::bind(function));
    }
#endif
    static struct download_start_event
    {
        static Efl_Event_Description const* description()
        { return EFL_UI_IMAGE_ZOOMABLE_EVENT_DOWNLOAD_START; }
        typedef void parameter_type;
    } const download_start_event;
#ifdef EFL_CXXPERIMENTAL
    template <typename F>
    typename std::enable_if<std::is_bind_expression<F>::value, ::efl::eolian::signal_connection>::type
    download_start_event_cb_add(F function)
    {
        return ::efl::eolian::event_add(download_start_event, *this, function);
    }
    template <typename F>
    typename std::enable_if<!std::is_bind_expression<F>::value, ::efl::eolian::signal_connection>::type
    download_start_event_cb_add(F function)
    {
        return ::efl::eolian::event_add(download_start_event, *this, std::bind(function));
    }
#endif
    static struct download_progress_event
    {
        static Efl_Event_Description const* description()
        { return EFL_UI_IMAGE_ZOOMABLE_EVENT_DOWNLOAD_PROGRESS; }
        typedef Elm_Photocam_Progress parameter_type;
    } const download_progress_event;
#ifdef EFL_CXXPERIMENTAL
    template <typename F>
    typename std::enable_if<std::is_bind_expression<F>::value, ::efl::eolian::signal_connection>::type
    download_progress_event_cb_add(F function)
    {
        return ::efl::eolian::event_add(download_progress_event, *this, function);
    }
    template <typename F>
    typename std::enable_if<!std::is_bind_expression<F>::value, ::efl::eolian::signal_connection>::type
    download_progress_event_cb_add(F function)
    {
        return ::efl::eolian::event_add(download_progress_event, *this, std::bind(function));
    }
#endif
    static struct download_done_event
    {
        static Efl_Event_Description const* description()
        { return EFL_UI_IMAGE_ZOOMABLE_EVENT_DOWNLOAD_DONE; }
        typedef void parameter_type;
    } const download_done_event;
#ifdef EFL_CXXPERIMENTAL
    template <typename F>
    typename std::enable_if<std::is_bind_expression<F>::value, ::efl::eolian::signal_connection>::type
    download_done_event_cb_add(F function)
    {
        return ::efl::eolian::event_add(download_done_event, *this, function);
    }
    template <typename F>
    typename std::enable_if<!std::is_bind_expression<F>::value, ::efl::eolian::signal_connection>::type
    download_done_event_cb_add(F function)
    {
        return ::efl::eolian::event_add(download_done_event, *this, std::bind(function));
    }
#endif
    static struct download_error_event
    {
        static Efl_Event_Description const* description()
        { return EFL_UI_IMAGE_ZOOMABLE_EVENT_DOWNLOAD_ERROR; }
        typedef Elm_Photocam_Error parameter_type;
    } const download_error_event;
#ifdef EFL_CXXPERIMENTAL
    template <typename F>
    typename std::enable_if<std::is_bind_expression<F>::value, ::efl::eolian::signal_connection>::type
    download_error_event_cb_add(F function)
    {
        return ::efl::eolian::event_add(download_error_event, *this, function);
    }
    template <typename F>
    typename std::enable_if<!std::is_bind_expression<F>::value, ::efl::eolian::signal_connection>::type
    download_error_event_cb_add(F function)
    {
        return ::efl::eolian::event_add(download_error_event, *this, std::bind(function));
    }
#endif
    /// @cond LOCAL
     ::efl::eolian::address_of_operator<Image_Zoomable,  ::efl::File,  ::efl::Loop_Consumer,  ::efl::Object,  ::efl::Part,  ::efl::Playable,  ::efl::Player,  ::efl::access::Action,  ::efl::access::Component,  ::efl::access::Object,  ::efl::access::widget::Action,  ::efl::canvas::Group,  ::efl::canvas::Object,  ::efl::canvas::Object_Animation,  ::efl::canvas::Pointer,  ::efl::gfx::Arrangement,  ::efl::gfx::Color,  ::efl::gfx::Entity,  ::efl::gfx::Filter,  ::efl::gfx::Hint,  ::efl::gfx::Image,  ::efl::gfx::Image_Load_Controller,  ::efl::gfx::Image_Orientable,  ::efl::gfx::Mapping,  ::efl::gfx::Stack,  ::efl::gfx::View,  ::efl::input::Clickable,  ::efl::input::Interface,  ::efl::layout::Calc,  ::efl::layout::Group,  ::efl::layout::Signal,  ::efl::ui::Dnd,  ::efl::ui::Draggable,  ::efl::ui::I18n,  ::efl::ui::Image,  ::efl::ui::L10n,  ::efl::ui::Property_Bind,  ::efl::ui::Scrollable,  ::efl::ui::Scrollbar,  ::efl::ui::Selection,  ::efl::ui::View,  ::efl::ui::Widget,  ::efl::ui::Zoom,  ::efl::ui::focus::Object> operator&() { return {this}; }
     ::efl::eolian::address_of_operator<Image_Zoomable const ,  ::efl::File const ,  ::efl::Loop_Consumer const ,  ::efl::Object const ,  ::efl::Part const ,  ::efl::Playable const ,  ::efl::Player const ,  ::efl::access::Action const ,  ::efl::access::Component const ,  ::efl::access::Object const ,  ::efl::access::widget::Action const ,  ::efl::canvas::Group const ,  ::efl::canvas::Object const ,  ::efl::canvas::Object_Animation const ,  ::efl::canvas::Pointer const ,  ::efl::gfx::Arrangement const ,  ::efl::gfx::Color const ,  ::efl::gfx::Entity const ,  ::efl::gfx::Filter const ,  ::efl::gfx::Hint const ,  ::efl::gfx::Image const ,  ::efl::gfx::Image_Load_Controller const ,  ::efl::gfx::Image_Orientable const ,  ::efl::gfx::Mapping const ,  ::efl::gfx::Stack const ,  ::efl::gfx::View const ,  ::efl::input::Clickable const ,  ::efl::input::Interface const ,  ::efl::layout::Calc const ,  ::efl::layout::Group const ,  ::efl::layout::Signal const ,  ::efl::ui::Dnd const ,  ::efl::ui::Draggable const ,  ::efl::ui::I18n const ,  ::efl::ui::Image const ,  ::efl::ui::L10n const ,  ::efl::ui::Property_Bind const ,  ::efl::ui::Scrollable const ,  ::efl::ui::Scrollbar const ,  ::efl::ui::Selection const ,  ::efl::ui::View const ,  ::efl::ui::Widget const ,  ::efl::ui::Zoom const ,  ::efl::ui::focus::Object const > operator&() const { return {this}; }
    /// @endcond
    ::efl::eo::wref<Image_Zoomable> _get_wref() const { return ::efl::eo::wref<Image_Zoomable>(*this); }
...
#ifdef EFL_CXXPERIMENTAL
    const Image_Zoomable* operator->() const { return this; }
    Image_Zoomable* operator->() { return this; }
    operator Eo*() const { return _eo_ptr(); }
#endif 
    friend bool operator==(Image_Zoomable const& lhs, Image_Zoomable const& rhs)
    { return lhs._get_concrete() == rhs._get_concrete(); }
    friend bool operator!=(Image_Zoomable const& lhs, Image_Zoomable const& rhs)
    { return !(lhs == rhs); }
};
static_assert(sizeof(Image_Zoomable) == sizeof(Eo*), "");
static_assert(std::is_standard_layout<Image_Zoomable>::value, "");
} } 
