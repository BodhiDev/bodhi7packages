#ifndef EFL_UI_SPIN_BUTTON_EO_HH
#define EFL_UI_SPIN_BUTTON_EO_HH
#include <Eo.h>
...
#ifndef EFL_UI_SPIN_BUTTON_FWD_GUARD
#define EFL_UI_SPIN_BUTTON_FWD_GUARD
namespace efl { namespace ui { 
struct Spin_Button;
} } 
namespace efl { namespace eo { template<> struct is_eolian_object< ::efl::ui::Spin_Button> : ::std::true_type {}; } }
namespace efl { namespace eo { template<> struct is_eolian_object< ::efl::ui::Spin_Button&> : ::std::true_type {}; } }
namespace efl { namespace eo { template<> struct is_eolian_object< ::efl::ui::Spin_Button const> : ::std::true_type {}; } }
namespace efl { namespace eo { template<> struct is_eolian_object< ::efl::ui::Spin_Button const&> : ::std::true_type {}; } }
#endif
...
namespace efl { namespace eo { template<> struct is_eolian_object< ::efl::ui::Layout_Base const&> : ::std::true_type {}; } }
#endif
#ifndef EFL_UI_SPIN_FWD_GUARD
#define EFL_UI_SPIN_FWD_GUARD
namespace efl { namespace ui { 
struct Spin;
} } 
namespace efl { namespace eo { template<> struct is_eolian_object< ::efl::ui::Spin> : ::std::true_type {}; } }
namespace efl { namespace eo { template<> struct is_eolian_object< ::efl::ui::Spin&> : ::std::true_type {}; } }
namespace efl { namespace eo { template<> struct is_eolian_object< ::efl::ui::Spin const> : ::std::true_type {}; } }
namespace efl { namespace eo { template<> struct is_eolian_object< ::efl::ui::Spin const&> : ::std::true_type {}; } }
#endif
...
namespace efl { namespace ui { 
struct Spin_Button {
    ::efl::eolian::return_traits<bool>::type wraparound_get() const;
    ::efl::eolian::return_traits<void>::type wraparound_set( ::efl::eolian::in_traits<bool>::type circulate) const;
#ifdef EFL_BETA_API_SUPPORT
    ::efl::eolian::return_traits<bool>::type direct_text_input_get() const;
#endif
#ifdef EFL_BETA_API_SUPPORT
    ::efl::eolian::return_traits<void>::type direct_text_input_set( ::efl::eolian::in_traits<bool>::type direct_text_input) const;
#endif
    static Efl_Class const* _eo_class()
    {
        return EFL_UI_SPIN_BUTTON_CLASS;
    }
    Eo* _eo_ptr() const { return *(reinterpret_cast<Eo **>(const_cast<Spin_Button *>(this))); }
    operator ::efl::ui::Spin_Button() const;
    operator ::efl::ui::Spin_Button&();
    operator ::efl::ui::Spin_Button const&() const;
    /// @cond LOCAL
     ::efl::eolian::address_of_operator<Spin_Button,  ::efl::Container,  ::efl::Loop_Consumer,  ::efl::Object,  ::efl::Part,  ::efl::access::Action,  ::efl::access::Component,  ::efl::access::Object,  ::efl::access::widget::Action,  ::efl::canvas::Group,  ::efl::canvas::Object,  ::efl::canvas::Object_Animation,  ::efl::canvas::Pointer,  ::efl::gfx::Color,  ::efl::gfx::Entity,  ::efl::gfx::Filter,  ::efl::gfx::Hint,  ::efl::gfx::Mapping,  ::efl::gfx::Stack,  ::efl::input::Interface,  ::efl::layout::Calc,  ::efl::layout::Group,  ::efl::layout::Signal,  ::efl::ui::Dnd,  ::efl::ui::Factory_Bind,  ::efl::ui::Format,  ::efl::ui::I18n,  ::efl::ui::L10n,  ::efl::ui::Layout_Base,  ::efl::ui::Layout_Orientable,  ::efl::ui::Property_Bind,  ::efl::ui::Range_Display,  ::efl::ui::Range_Interactive,  ::efl::ui::Selection,  ::efl::ui::Spin,  ::efl::ui::View,  ::efl::ui::Widget,  ::efl::ui::focus::Composition,  ::efl::ui::focus::Object> operator&() { return {this}; }
     ::efl::eolian::address_of_operator<Spin_Button const ,  ::efl::Container const ,  ::efl::Loop_Consumer const ,  ::efl::Object const ,  ::efl::Part const ,  ::efl::access::Action const ,  ::efl::access::Component const ,  ::efl::access::Object const ,  ::efl::access::widget::Action const ,  ::efl::canvas::Group const ,  ::efl::canvas::Object const ,  ::efl::canvas::Object_Animation const ,  ::efl::canvas::Pointer const ,  ::efl::gfx::Color const ,  ::efl::gfx::Entity const ,  ::efl::gfx::Filter const ,  ::efl::gfx::Hint const ,  ::efl::gfx::Mapping const ,  ::efl::gfx::Stack const ,  ::efl::input::Interface const ,  ::efl::layout::Calc const ,  ::efl::layout::Group const ,  ::efl::layout::Signal const ,  ::efl::ui::Dnd const ,  ::efl::ui::Factory_Bind const ,  ::efl::ui::Format const ,  ::efl::ui::I18n const ,  ::efl::ui::L10n const ,  ::efl::ui::Layout_Base const ,  ::efl::ui::Layout_Orientable const ,  ::efl::ui::Property_Bind const ,  ::efl::ui::Range_Display const ,  ::efl::ui::Range_Interactive const ,  ::efl::ui::Selection const ,  ::efl::ui::Spin const ,  ::efl::ui::View const ,  ::efl::ui::Widget const ,  ::efl::ui::focus::Composition const ,  ::efl::ui::focus::Object const > operator&() const { return {this}; }
    /// @endcond
};
} } 
}
namespace efl { namespace ui { 
struct Spin_Button : private ::efl::eo::concrete
    ...
    , EO_CXX_INHERIT(::efl::ui::Spin)
    , EO_CXX_INHERIT(::efl::ui::View)
    , EO_CXX_INHERIT(::efl::ui::Widget)
    , EO_CXX_INHERIT(::efl::ui::focus::Composition)
    , EO_CXX_INHERIT(::efl::ui::focus::Object)
{
    explicit Spin_Button( ::Eo* eo)
        : ::efl::eo::concrete(eo) {}
    Spin_Button(std::nullptr_t)
        : ::efl::eo::concrete(nullptr) {}
    explicit Spin_Button() = default;
    Spin_Button(Spin_Button const&) = default;
    Spin_Button(Spin_Button&&) = default;
    Spin_Button& operator=(Spin_Button const&) = default;
    Spin_Button& operator=(Spin_Button&&) = default;
    template <typename Derived>
    Spin_Button(Derived&& derived
        , typename std::enable_if<
            ::efl::eo::is_eolian_object<Derived>::value
             && std::is_base_of< Spin_Button, Derived>::value>::type* = 0)
            : ::efl::eo::concrete(derived._eo_ptr()) {}

    Spin_Button( ::efl::eo::instantiate_t)
    {
        ::efl::eolian::do_eo_add( ::efl::eo::concrete::_eo_raw, ::efl::eo::concrete{nullptr}, _eo_class());
    }
    template <typename T>
    explicit Spin_Button( ::efl::eo::instantiate_t, T&& parent, typename std::enable_if< ::efl::eo::is_eolian_object<T>::value>::type* = 0)
    {
        ::efl::eolian::do_eo_add( ::efl::eo::concrete::_eo_raw, parent, _eo_class());
    }
    template <typename F> Spin_Button( ::efl::eo::instantiate_t, F&& f, typename ::std::enable_if< ::efl::eolian::is_constructor_lambda<F, Spin_Button >::value>::type* = 0)
    {
        ::efl::eolian::do_eo_add( ::efl::eo::concrete::_eo_raw, ::efl::eo::concrete{nullptr}, _eo_class(), *this, std::forward<F>(f));
    }
    template <typename T, typename F> Spin_Button(  ::efl::eo::instantiate_t, T&& parent, F&& f, typename ::std::enable_if< ::efl::eolian::is_constructor_lambda<F, Spin_Button >::value && ::efl::eo::is_eolian_object<T>::value>::type* = 0)
    {
    ...
    /// @cond LOCAL
     ...
     ::efl::eolian::address_of_operator<Spin_Button const ,  ::efl::Container const ,  ::efl::Loop_Consumer const ,  ::efl::Object const ,  ::efl::Part const ,  ::efl::access::Action const ,  ::efl::access::Component const ,  ::efl::access::Object const ,  ::efl::access::widget::Action const ,  ::efl::canvas::Group const ,  ::efl::canvas::Object const ,  ::efl::canvas::Object_Animation const ,  ::efl::canvas::Pointer const ,  ::efl::gfx::Color const ,  ::efl::gfx::Entity const ,  ::efl::gfx::Filter const ,  ::efl::gfx::Hint const ,  ::efl::gfx::Mapping const ,  ::efl::gfx::Stack const ,  ::efl::input::Interface const ,  ::efl::layout::Calc const ,  ::efl::layout::Group const ,  ::efl::layout::Signal const ,  ::efl::ui::Dnd const ,  ::efl::ui::Factory_Bind const ,  ::efl::ui::Format const ,  ::efl::ui::I18n const ,  ::efl::ui::L10n const ,  ::efl::ui::Layout_Base const ,  ::efl::ui::Layout_Orientable const ,  ::efl::ui::Property_Bind const ,  ::efl::ui::Range_Display const ,  ::efl::ui::Range_Interactive const ,  ::efl::ui::Selection const ,  ::efl::ui::Spin const ,  ::efl::ui::View const ,  ::efl::ui::Widget const ,  ::efl::ui::focus::Composition const ,  ::efl::ui::focus::Object const > operator&() const { return {this}; }
    /// @endcond
    ::efl::eo::wref<Spin_Button> _get_wref() const { return ::efl::eo::wref<Spin_Button>(*this); }
    ...
    const Spin_Button* operator->() const { return this; }
    Spin_Button* operator->() { return this; }
    operator Eo*() const { return _eo_ptr(); }
#endif 
    friend bool operator==(Spin_Button const& lhs, Spin_Button const& rhs)
    { return lhs._get_concrete() == rhs._get_concrete(); }
    friend bool operator!=(Spin_Button const& lhs, Spin_Button const& rhs)
    { return !(lhs == rhs); }
};
static_assert(sizeof(Spin_Button) == sizeof(Eo*), "");
static_assert(std::is_standard_layout<Spin_Button>::value, "");
} } 
