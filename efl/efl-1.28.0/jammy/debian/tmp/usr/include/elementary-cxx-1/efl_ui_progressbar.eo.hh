#ifndef EFL_UI_PROGRESSBAR_EO_HH
#define EFL_UI_PROGRESSBAR_EO_HH
#include <Eo.h>
...
#ifndef EFL_UI_PROGRESSBAR_FWD_GUARD
#define EFL_UI_PROGRESSBAR_FWD_GUARD
namespace efl { namespace ui { 
struct Progressbar;
} } 
namespace efl { namespace eo { template<> struct is_eolian_object< ::efl::ui::Progressbar> : ::std::true_type {}; } }
namespace efl { namespace eo { template<> struct is_eolian_object< ::efl::ui::Progressbar&> : ::std::true_type {}; } }
namespace efl { namespace eo { template<> struct is_eolian_object< ::efl::ui::Progressbar const> : ::std::true_type {}; } }
namespace efl { namespace eo { template<> struct is_eolian_object< ::efl::ui::Progressbar const&> : ::std::true_type {}; } }
#endif
...
struct Progressbar {
    ...
    ::efl::eolian::return_traits<bool>::type infinite_mode_get() const;
#endif
#ifdef EFL_BETA_API_SUPPORT
    ::efl::eolian::return_traits<void>::type infinite_mode_set( ::efl::eolian::in_traits<bool>::type state) const;
#endif
#ifdef EFL_BETA_API_SUPPORT
    ::efl::eolian::return_traits<bool>::type show_progress_label_get() const;
#endif
#ifdef EFL_BETA_API_SUPPORT
    ::efl::eolian::return_traits<void>::type show_progress_label_set( ::efl::eolian::in_traits<bool>::type show) const;
#endif
    static Efl_Class const* _eo_class()
    {
        return EFL_UI_PROGRESSBAR_CLASS;
    }
    Eo* _eo_ptr() const { return *(reinterpret_cast<Eo **>(const_cast<Progressbar *>(this))); }
    operator ::efl::ui::Progressbar() const;
    operator ::efl::ui::Progressbar&();
    operator ::efl::ui::Progressbar const&() const;
    /// @cond LOCAL
     ::efl::eolian::address_of_operator<Progressbar,  ::efl::Container,  ::efl::Content,  ::efl::Loop_Consumer,  ::efl::Object,  ::efl::Part,  ::efl::Text,  ::efl::Text_Markup,  ::efl::access::Component,  ::efl::access::Object,  ::efl::canvas::Group,  ::efl::canvas::Object,  ::efl::canvas::Object_Animation,  ::efl::canvas::Pointer,  ::efl::gfx::Color,  ::efl::gfx::Entity,  ::efl::gfx::Filter,  ::efl::gfx::Hint,  ::efl::gfx::Mapping,  ::efl::gfx::Stack,  ::efl::input::Interface,  ::efl::layout::Calc,  ::efl::layout::Group,  ::efl::layout::Signal,  ::efl::ui::Dnd,  ::efl::ui::Factory_Bind,  ::efl::ui::Format,  ::efl::ui::I18n,  ::efl::ui::L10n,  ::efl::ui::Layout_Base,  ::efl::ui::Layout_Orientable,  ::efl::ui::Property_Bind,  ::efl::ui::Range_Display,  ::efl::ui::Selection,  ::efl::ui::View,  ::efl::ui::Widget,  ::efl::ui::focus::Object> operator&() { return {this}; }
     ::efl::eolian::address_of_operator<Progressbar const ,  ::efl::Container const ,  ::efl::Content const ,  ::efl::Loop_Consumer const ,  ::efl::Object const ,  ::efl::Part const ,  ::efl::Text const ,  ::efl::Text_Markup const ,  ::efl::access::Component const ,  ::efl::access::Object const ,  ::efl::canvas::Group const ,  ::efl::canvas::Object const ,  ::efl::canvas::Object_Animation const ,  ::efl::canvas::Pointer const ,  ::efl::gfx::Color const ,  ::efl::gfx::Entity const ,  ::efl::gfx::Filter const ,  ::efl::gfx::Hint const ,  ::efl::gfx::Mapping const ,  ::efl::gfx::Stack const ,  ::efl::input::Interface const ,  ::efl::layout::Calc const ,  ::efl::layout::Group const ,  ::efl::layout::Signal const ,  ::efl::ui::Dnd const ,  ::efl::ui::Factory_Bind const ,  ::efl::ui::Format const ,  ::efl::ui::I18n const ,  ::efl::ui::L10n const ,  ::efl::ui::Layout_Base const ,  ::efl::ui::Layout_Orientable const ,  ::efl::ui::Property_Bind const ,  ::efl::ui::Range_Display const ,  ::efl::ui::Selection const ,  ::efl::ui::View const ,  ::efl::ui::Widget const ,  ::efl::ui::focus::Object const > operator&() const { return {this}; }
    /// @endcond
};
} } 
}
namespace efl { namespace ui { 
struct Progressbar : private ::efl::eo::concrete
    ...
    , EO_CXX_INHERIT(::efl::ui::focus::Object)
{
    ...
    Progressbar& operator=(Progressbar const&) = default;
    Progressbar& operator=(Progressbar&&) = default;
    template <typename Derived>
    Progressbar(Derived&& derived
        , typename std::enable_if<
            ::efl::eo::is_eolian_object<Derived>::value
             && std::is_base_of< Progressbar, Derived>::value>::type* = 0)
            : ::efl::eo::concrete(derived._eo_ptr()) {}

    Progressbar( ::efl::eo::instantiate_t)
    {
        ::efl::eolian::do_eo_add( ::efl::eo::concrete::_eo_raw, ::efl::eo::concrete{nullptr}, _eo_class());
    }
    template <typename T>
    explicit Progressbar( ::efl::eo::instantiate_t, T&& parent, typename std::enable_if< ::efl::eo::is_eolian_object<T>::value>::type* = 0)
    {
        ::efl::eolian::do_eo_add( ::efl::eo::concrete::_eo_raw, parent, _eo_class());
    }
    template <typename F> Progressbar( ::efl::eo::instantiate_t, F&& f, typename ::std::enable_if< ::efl::eolian::is_constructor_lambda<F, Progressbar >::value>::type* = 0)
    {
        ::efl::eolian::do_eo_add( ::efl::eo::concrete::_eo_raw, ::efl::eo::concrete{nullptr}, _eo_class(), *this, std::forward<F>(f));
    }
    template <typename T, typename F> Progressbar(  ::efl::eo::instantiate_t, T&& parent, F&& f, typename ::std::enable_if< ::efl::eolian::is_constructor_lambda<F, Progressbar >::value && ::efl::eo::is_eolian_object<T>::value>::type* = 0)
    {
    ...
    /// @cond LOCAL
     ...
     ::efl::eolian::address_of_operator<Progressbar const ,  ::efl::Container const ,  ::efl::Content const ,  ::efl::Loop_Consumer const ,  ::efl::Object const ,  ::efl::Part const ,  ::efl::Text const ,  ::efl::Text_Markup const ,  ::efl::access::Component const ,  ::efl::access::Object const ,  ::efl::canvas::Group const ,  ::efl::canvas::Object const ,  ::efl::canvas::Object_Animation const ,  ::efl::canvas::Pointer const ,  ::efl::gfx::Color const ,  ::efl::gfx::Entity const ,  ::efl::gfx::Filter const ,  ::efl::gfx::Hint const ,  ::efl::gfx::Mapping const ,  ::efl::gfx::Stack const ,  ::efl::input::Interface const ,  ::efl::layout::Calc const ,  ::efl::layout::Group const ,  ::efl::layout::Signal const ,  ::efl::ui::Dnd const ,  ::efl::ui::Factory_Bind const ,  ::efl::ui::Format const ,  ::efl::ui::I18n const ,  ::efl::ui::L10n const ,  ::efl::ui::Layout_Base const ,  ::efl::ui::Layout_Orientable const ,  ::efl::ui::Property_Bind const ,  ::efl::ui::Range_Display const ,  ::efl::ui::Selection const ,  ::efl::ui::View const ,  ::efl::ui::Widget const ,  ::efl::ui::focus::Object const > operator&() const { return {this}; }
    /// @endcond
    ::efl::eo::wref<Progressbar> _get_wref() const { return ::efl::eo::wref<Progressbar>(*this); }
    ...
    const Progressbar* operator->() const { return this; }
    Progressbar* operator->() { return this; }
    operator Eo*() const { return _eo_ptr(); }
#endif 
    friend bool operator==(Progressbar const& lhs, Progressbar const& rhs)
    { return lhs._get_concrete() == rhs._get_concrete(); }
    friend bool operator!=(Progressbar const& lhs, Progressbar const& rhs)
    { return !(lhs == rhs); }
};
static_assert(sizeof(Progressbar) == sizeof(Eo*), "");
static_assert(std::is_standard_layout<Progressbar>::value, "");
} } 
