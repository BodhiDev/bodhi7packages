#ifndef EFL_UI_TIMEPICKER_EO_HH
#define EFL_UI_TIMEPICKER_EO_HH
#include <Eo.h>
...
#ifndef EFL_UI_TIMEPICKER_FWD_GUARD
#define EFL_UI_TIMEPICKER_FWD_GUARD
namespace efl { namespace ui { 
struct Timepicker;
} } 
namespace efl { namespace eo { template<> struct is_eolian_object< ::efl::ui::Timepicker> : ::std::true_type {}; } }
namespace efl { namespace eo { template<> struct is_eolian_object< ::efl::ui::Timepicker&> : ::std::true_type {}; } }
namespace efl { namespace eo { template<> struct is_eolian_object< ::efl::ui::Timepicker const> : ::std::true_type {}; } }
namespace efl { namespace eo { template<> struct is_eolian_object< ::efl::ui::Timepicker const&> : ::std::true_type {}; } }
#endif
...
namespace efl { namespace ui { 
struct Timepicker {
    ::efl::eolian::return_traits<void>::type time_get( ::efl::eolian::out_traits<int>::type hour,  ::efl::eolian::out_traits<int>::type min) const;
    ::efl::eolian::return_traits<void>::type time_set( ::efl::eolian::in_traits<int>::type hour,  ::efl::eolian::in_traits<int>::type min) const;
    ::efl::eolian::return_traits<bool>::type is_24hour_get() const;
    ::efl::eolian::return_traits<void>::type is_24hour_set( ::efl::eolian::in_traits<bool>::type is_24hour) const;
    static Efl_Class const* _eo_class()
    {
        return EFL_UI_TIMEPICKER_CLASS;
    }
    Eo* _eo_ptr() const { return *(reinterpret_cast<Eo **>(const_cast<Timepicker *>(this))); }
    operator ::efl::ui::Timepicker() const;
    operator ::efl::ui::Timepicker&();
    operator ::efl::ui::Timepicker const&() const;
    /// @cond LOCAL
     ::efl::eolian::address_of_operator<Timepicker,  ::efl::Container,  ::efl::Loop_Consumer,  ::efl::Object,  ::efl::Part,  ::efl::access::Component,  ::efl::access::Object,  ::efl::canvas::Group,  ::efl::canvas::Object,  ::efl::canvas::Object_Animation,  ::efl::canvas::Pointer,  ::efl::gfx::Color,  ::efl::gfx::Entity,  ::efl::gfx::Filter,  ::efl::gfx::Hint,  ::efl::gfx::Mapping,  ::efl::gfx::Stack,  ::efl::input::Interface,  ::efl::layout::Calc,  ::efl::layout::Group,  ::efl::layout::Signal,  ::efl::ui::Dnd,  ::efl::ui::Factory_Bind,  ::efl::ui::I18n,  ::efl::ui::L10n,  ::efl::ui::Layout_Base,  ::efl::ui::Property_Bind,  ::efl::ui::Selection,  ::efl::ui::View,  ::efl::ui::Widget,  ::efl::ui::focus::Object> operator&() { return {this}; }
     ::efl::eolian::address_of_operator<Timepicker const ,  ::efl::Container const ,  ::efl::Loop_Consumer const ,  ::efl::Object const ,  ::efl::Part const ,  ::efl::access::Component const ,  ::efl::access::Object const ,  ::efl::canvas::Group const ,  ::efl::canvas::Object const ,  ::efl::canvas::Object_Animation const ,  ::efl::canvas::Pointer const ,  ::efl::gfx::Color const ,  ::efl::gfx::Entity const ,  ::efl::gfx::Filter const ,  ::efl::gfx::Hint const ,  ::efl::gfx::Mapping const ,  ::efl::gfx::Stack const ,  ::efl::input::Interface const ,  ::efl::layout::Calc const ,  ::efl::layout::Group const ,  ::efl::layout::Signal const ,  ::efl::ui::Dnd const ,  ::efl::ui::Factory_Bind const ,  ::efl::ui::I18n const ,  ::efl::ui::L10n const ,  ::efl::ui::Layout_Base const ,  ::efl::ui::Property_Bind const ,  ::efl::ui::Selection const ,  ::efl::ui::View const ,  ::efl::ui::Widget const ,  ::efl::ui::focus::Object const > operator&() const { return {this}; }
    /// @endcond
};
} } 
}
namespace efl { namespace ui { 
struct Timepicker : private ::efl::eo::concrete
...
{
    explicit Timepicker( ::Eo* eo)
        : ::efl::eo::concrete(eo) {}
    Timepicker(std::nullptr_t)
        : ::efl::eo::concrete(nullptr) {}
    explicit Timepicker() = default;
    Timepicker(Timepicker const&) = default;
    Timepicker(Timepicker&&) = default;
    Timepicker& operator=(Timepicker const&) = default;
    Timepicker& operator=(Timepicker&&) = default;
    template <typename Derived>
    Timepicker(Derived&& derived
        , typename std::enable_if<
            ::efl::eo::is_eolian_object<Derived>::value
             && std::is_base_of< Timepicker, Derived>::value>::type* = 0)
            : ::efl::eo::concrete(derived._eo_ptr()) {}

    Timepicker( ::efl::eo::instantiate_t)
    {
        ::efl::eolian::do_eo_add( ::efl::eo::concrete::_eo_raw, ::efl::eo::concrete{nullptr}, _eo_class());
    }
    template <typename T>
    explicit Timepicker( ::efl::eo::instantiate_t, T&& parent, typename std::enable_if< ::efl::eo::is_eolian_object<T>::value>::type* = 0)
    {
        ::efl::eolian::do_eo_add( ::efl::eo::concrete::_eo_raw, parent, _eo_class());
    }
    template <typename F> Timepicker( ::efl::eo::instantiate_t, F&& f, typename ::std::enable_if< ::efl::eolian::is_constructor_lambda<F, Timepicker >::value>::type* = 0)
    {
        ::efl::eolian::do_eo_add( ::efl::eo::concrete::_eo_raw, ::efl::eo::concrete{nullptr}, _eo_class(), *this, std::forward<F>(f));
    }
    template <typename T, typename F> Timepicker(  ::efl::eo::instantiate_t, T&& parent, F&& f, typename ::std::enable_if< ::efl::eolian::is_constructor_lambda<F, Timepicker >::value && ::efl::eo::is_eolian_object<T>::value>::type* = 0)
    {
    ...
    Eo* _eo_ptr() const { return *(reinterpret_cast<Eo **>(const_cast<Timepicker *>(this))); }
    static struct time_changed_event
    {
        static Efl_Event_Description const* description()
        { return EFL_UI_TIMEPICKER_EVENT_TIME_CHANGED; }
        typedef void parameter_type;
    } const time_changed_event;
#ifdef EFL_CXXPERIMENTAL
    template <typename F>
    typename std::enable_if<std::is_bind_expression<F>::value, ::efl::eolian::signal_connection>::type
    time_changed_event_cb_add(F function)
    {
        return ::efl::eolian::event_add(time_changed_event, *this, function);
    }
    template <typename F>
    typename std::enable_if<!std::is_bind_expression<F>::value, ::efl::eolian::signal_connection>::type
    time_changed_event_cb_add(F function)
    {
        return ::efl::eolian::event_add(time_changed_event, *this, std::bind(function));
    }
#endif
    /// @cond LOCAL
     ::efl::eolian::address_of_operator<Timepicker,  ::efl::Container,  ::efl::Loop_Consumer,  ::efl::Object,  ::efl::Part,  ::efl::access::Component,  ::efl::access::Object,  ::efl::canvas::Group,  ::efl::canvas::Object,  ::efl::canvas::Object_Animation,  ::efl::canvas::Pointer,  ::efl::gfx::Color,  ::efl::gfx::Entity,  ::efl::gfx::Filter,  ::efl::gfx::Hint,  ::efl::gfx::Mapping,  ::efl::gfx::Stack,  ::efl::input::Interface,  ::efl::layout::Calc,  ::efl::layout::Group,  ::efl::layout::Signal,  ::efl::ui::Dnd,  ::efl::ui::Factory_Bind,  ::efl::ui::I18n,  ::efl::ui::L10n,  ::efl::ui::Layout_Base,  ::efl::ui::Property_Bind,  ::efl::ui::Selection,  ::efl::ui::View,  ::efl::ui::Widget,  ::efl::ui::focus::Object> operator&() { return {this}; }
     ::efl::eolian::address_of_operator<Timepicker const ,  ::efl::Container const ,  ::efl::Loop_Consumer const ,  ::efl::Object const ,  ::efl::Part const ,  ::efl::access::Component const ,  ::efl::access::Object const ,  ::efl::canvas::Group const ,  ::efl::canvas::Object const ,  ::efl::canvas::Object_Animation const ,  ::efl::canvas::Pointer const ,  ::efl::gfx::Color const ,  ::efl::gfx::Entity const ,  ::efl::gfx::Filter const ,  ::efl::gfx::Hint const ,  ::efl::gfx::Mapping const ,  ::efl::gfx::Stack const ,  ::efl::input::Interface const ,  ::efl::layout::Calc const ,  ::efl::layout::Group const ,  ::efl::layout::Signal const ,  ::efl::ui::Dnd const ,  ::efl::ui::Factory_Bind const ,  ::efl::ui::I18n const ,  ::efl::ui::L10n const ,  ::efl::ui::Layout_Base const ,  ::efl::ui::Property_Bind const ,  ::efl::ui::Selection const ,  ::efl::ui::View const ,  ::efl::ui::Widget const ,  ::efl::ui::focus::Object const > operator&() const { return {this}; }
    /// @endcond
    ::efl::eo::wref<Timepicker> _get_wref() const { return ::efl::eo::wref<Timepicker>(*this); }
...
#ifdef EFL_CXXPERIMENTAL
    const Timepicker* operator->() const { return this; }
    Timepicker* operator->() { return this; }
    operator Eo*() const { return _eo_ptr(); }
#endif 
    friend bool operator==(Timepicker const& lhs, Timepicker const& rhs)
    { return lhs._get_concrete() == rhs._get_concrete(); }
    friend bool operator!=(Timepicker const& lhs, Timepicker const& rhs)
    { return !(lhs == rhs); }
};
static_assert(sizeof(Timepicker) == sizeof(Eo*), "");
static_assert(std::is_standard_layout<Timepicker>::value, "");
} } 
