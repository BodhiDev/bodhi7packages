...
EAPI EAPI_WEAK const Efl_Class *efl_io_writer_fd_mixin_get(void) EINA_CONST;
 ...
 * @ingroup Efl_Io_Writer_Fd
 */
EAPI EAPI_WEAK void efl_io_writer_fd_set(Eo *obj, int fd);
#endif
 ...
 * @ingroup Efl_Io_Writer_Fd
 */
EAPI EAPI_WEAK int efl_io_writer_fd_get(const Eo *obj);
