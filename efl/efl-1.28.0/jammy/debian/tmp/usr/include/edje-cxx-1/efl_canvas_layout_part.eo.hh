#ifndef EFL_CANVAS_LAYOUT_PART_EO_HH
#define EFL_CANVAS_LAYOUT_PART_EO_HH
#include <Eo.h>
...
struct Layout_Part {
    ...
    ::efl::eolian::return_traits<void>::type state_get( ::efl::eolian::out_traits< ::efl::eina::string_view>::type state,  ::efl::eolian::out_traits<double>::type val) const;
#endif
    static Efl_Class const* _eo_class()
    {
        return EFL_CANVAS_LAYOUT_PART_CLASS;
    }
    Eo* _eo_ptr() const { return *(reinterpret_cast<Eo **>(const_cast<Layout_Part *>(this))); }
    operator ::efl::canvas::Layout_Part() const;
    operator ::efl::canvas::Layout_Part&();
    operator ::efl::canvas::Layout_Part const&() const;
    /// @cond LOCAL
     ::efl::eolian::address_of_operator<Layout_Part,  ::efl::Object,  ::efl::canvas::Layout_Part_Type_Provider,  ::efl::gfx::Entity,  ::efl::ui::Drag> operator&() { return {this}; }
     ::efl::eolian::address_of_operator<Layout_Part const ,  ::efl::Object const ,  ::efl::canvas::Layout_Part_Type_Provider const ,  ::efl::gfx::Entity const ,  ::efl::ui::Drag const > operator&() const { return {this}; }
    /// @endcond
};
} } 
}
