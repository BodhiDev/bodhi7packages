#ifndef ELDBUS_MODEL_CONNECTION_EO_HH
#define ELDBUS_MODEL_CONNECTION_EO_HH
#include <Eo.h>
...
#ifndef ELDBUS_MODEL_CONNECTION_FWD_GUARD
#define ELDBUS_MODEL_CONNECTION_FWD_GUARD
namespace eldbus { namespace model { 
struct Connection;
} } 
namespace efl { namespace eo { template<> struct is_eolian_object< ::eldbus::model::Connection> : ::std::true_type {}; } }
namespace efl { namespace eo { template<> struct is_eolian_object< ::eldbus::model::Connection&> : ::std::true_type {}; } }
namespace efl { namespace eo { template<> struct is_eolian_object< ::eldbus::model::Connection const> : ::std::true_type {}; } }
namespace efl { namespace eo { template<> struct is_eolian_object< ::eldbus::model::Connection const&> : ::std::true_type {}; } }
#endif
...
struct Connection {
    ...
    Eo* _eo_ptr() const { return *(reinterpret_cast<Eo **>(const_cast<Connection *>(this))); }
    operator ::eldbus::model::Connection() const;
    operator ::eldbus::model::Connection&();
    operator ::eldbus::model::Connection const&() const;
    /// @cond LOCAL
     ::efl::eolian::address_of_operator<Connection,  ::efl::Loop_Consumer,  ::efl::Loop_Model,  ::efl::Model,  ::efl::Object,  ::eldbus::Model> operator&() { return {this}; }
     ::efl::eolian::address_of_operator<Connection const ,  ::efl::Loop_Consumer const ,  ::efl::Loop_Model const ,  ::efl::Model const ,  ::efl::Object const ,  ::eldbus::Model const > operator&() const { return {this}; }
    /// @endcond
};
} } 
}
namespace eldbus { namespace model { 
struct Connection : private ::efl::eo::concrete
    ...
    , EO_CXX_INHERIT(::eldbus::Model)
{
    ...
    Connection(Derived&& derived
        , typename std::enable_if<
            ::efl::eo::is_eolian_object<Derived>::value
             && std::is_base_of< Connection, Derived>::value>::type* = 0)
            : ::efl::eo::concrete(derived._eo_ptr()) {}

    Connection( ::efl::eo::instantiate_t)
    {
        ::efl::eolian::do_eo_add( ::efl::eo::concrete::_eo_raw, ::efl::eo::concrete{nullptr}, _eo_class());
    }
    template <typename T>
    explicit Connection( ::efl::eo::instantiate_t, T&& parent, typename std::enable_if< ::efl::eo::is_eolian_object<T>::value>::type* = 0)
    {
        ::efl::eolian::do_eo_add( ::efl::eo::concrete::_eo_raw, parent, _eo_class());
    }
    template <typename F> Connection( ::efl::eo::instantiate_t, F&& f, typename ::std::enable_if< ::efl::eolian::is_constructor_lambda<F, Connection >::value>::type* = 0)
    {
        ::efl::eolian::do_eo_add( ::efl::eo::concrete::_eo_raw, ::efl::eo::concrete{nullptr}, _eo_class(), *this, std::forward<F>(f));
    }
    template <typename T, typename F> Connection(  ::efl::eo::instantiate_t, T&& parent, F&& f, typename ::std::enable_if< ::efl::eolian::is_constructor_lambda<F, Connection >::value && ::efl::eo::is_eolian_object<T>::value>::type* = 0)
    {
    ...
    /// @cond LOCAL
     ...
     ::efl::eolian::address_of_operator<Connection const ,  ::efl::Loop_Consumer const ,  ::efl::Loop_Model const ,  ::efl::Model const ,  ::efl::Object const ,  ::eldbus::Model const > operator&() const { return {this}; }
    /// @endcond
    ::efl::eo::wref<Connection> _get_wref() const { return ::efl::eo::wref<Connection>(*this); }
    ...
    const Connection* operator->() const { return this; }
...
static_assert(sizeof(Connection) == sizeof(Eo*), "");
