#ifndef EFL_CANVAS_EVENT_GRABBER_EO_HH
#define EFL_CANVAS_EVENT_GRABBER_EO_HH
#include <Eo.h>
...
#ifndef EFL_CANVAS_EVENT_GRABBER_FWD_GUARD
#define EFL_CANVAS_EVENT_GRABBER_FWD_GUARD
namespace efl { namespace canvas { 
struct Event_Grabber;
} } 
namespace efl { namespace eo { template<> struct is_eolian_object< ::efl::canvas::Event_Grabber> : ::std::true_type {}; } }
namespace efl { namespace eo { template<> struct is_eolian_object< ::efl::canvas::Event_Grabber&> : ::std::true_type {}; } }
namespace efl { namespace eo { template<> struct is_eolian_object< ::efl::canvas::Event_Grabber const> : ::std::true_type {}; } }
namespace efl { namespace eo { template<> struct is_eolian_object< ::efl::canvas::Event_Grabber const&> : ::std::true_type {}; } }
#endif
...
struct Event_Grabber {
    ...
    ::efl::eolian::return_traits<bool>::type freeze_when_visible_get() const;
#endif
#ifdef EFL_BETA_API_SUPPORT
    ::efl::eolian::return_traits<void>::type freeze_when_visible_set( ::efl::eolian::in_traits<bool>::type set) const;
#endif
    static Efl_Class const* _eo_class()
    {
        return EFL_CANVAS_EVENT_GRABBER_CLASS;
    }
    Eo* _eo_ptr() const { return *(reinterpret_cast<Eo **>(const_cast<Event_Grabber *>(this))); }
    operator ::efl::canvas::Event_Grabber() const;
    operator ::efl::canvas::Event_Grabber&();
    operator ::efl::canvas::Event_Grabber const&() const;
    /// @cond LOCAL
     ::efl::eolian::address_of_operator<Event_Grabber,  ::efl::Loop_Consumer,  ::efl::Object,  ::efl::canvas::Group,  ::efl::canvas::Object,  ::efl::canvas::Object_Animation,  ::efl::canvas::Pointer,  ::efl::gfx::Color,  ::efl::gfx::Entity,  ::efl::gfx::Filter,  ::efl::gfx::Hint,  ::efl::gfx::Mapping,  ::efl::gfx::Stack,  ::efl::input::Interface> operator&() { return {this}; }
     ::efl::eolian::address_of_operator<Event_Grabber const ,  ::efl::Loop_Consumer const ,  ::efl::Object const ,  ::efl::canvas::Group const ,  ::efl::canvas::Object const ,  ::efl::canvas::Object_Animation const ,  ::efl::canvas::Pointer const ,  ::efl::gfx::Color const ,  ::efl::gfx::Entity const ,  ::efl::gfx::Filter const ,  ::efl::gfx::Hint const ,  ::efl::gfx::Mapping const ,  ::efl::gfx::Stack const ,  ::efl::input::Interface const > operator&() const { return {this}; }
    /// @endcond
};
} } 
}
namespace efl { namespace canvas { 
struct Event_Grabber : private ::efl::eo::concrete
...
{
    explicit Event_Grabber( ::Eo* eo)
        : ::efl::eo::concrete(eo) {}
    Event_Grabber(std::nullptr_t)
        : ::efl::eo::concrete(nullptr) {}
    explicit Event_Grabber() = default;
    Event_Grabber(Event_Grabber const&) = default;
    Event_Grabber(Event_Grabber&&) = default;
    Event_Grabber& operator=(Event_Grabber const&) = default;
    Event_Grabber& operator=(Event_Grabber&&) = default;
    template <typename Derived>
    Event_Grabber(Derived&& derived
        , typename std::enable_if<
            ::efl::eo::is_eolian_object<Derived>::value
             && std::is_base_of< Event_Grabber, Derived>::value>::type* = 0)
            : ::efl::eo::concrete(derived._eo_ptr()) {}

    Event_Grabber( ::efl::eo::instantiate_t)
    {
        ::efl::eolian::do_eo_add( ::efl::eo::concrete::_eo_raw, ::efl::eo::concrete{nullptr}, _eo_class());
    }
    template <typename T>
    explicit Event_Grabber( ::efl::eo::instantiate_t, T&& parent, typename std::enable_if< ::efl::eo::is_eolian_object<T>::value>::type* = 0)
    {
        ::efl::eolian::do_eo_add( ::efl::eo::concrete::_eo_raw, parent, _eo_class());
    }
    template <typename F> Event_Grabber( ::efl::eo::instantiate_t, F&& f, typename ::std::enable_if< ::efl::eolian::is_constructor_lambda<F, Event_Grabber >::value>::type* = 0)
    {
        ::efl::eolian::do_eo_add( ::efl::eo::concrete::_eo_raw, ::efl::eo::concrete{nullptr}, _eo_class(), *this, std::forward<F>(f));
    }
    template <typename T, typename F> Event_Grabber(  ::efl::eo::instantiate_t, T&& parent, F&& f, typename ::std::enable_if< ::efl::eolian::is_constructor_lambda<F, Event_Grabber >::value && ::efl::eo::is_eolian_object<T>::value>::type* = 0)
    {
    ...
    /// @cond LOCAL
     ...
     ::efl::eolian::address_of_operator<Event_Grabber const ,  ::efl::Loop_Consumer const ,  ::efl::Object const ,  ::efl::canvas::Group const ,  ::efl::canvas::Object const ,  ::efl::canvas::Object_Animation const ,  ::efl::canvas::Pointer const ,  ::efl::gfx::Color const ,  ::efl::gfx::Entity const ,  ::efl::gfx::Filter const ,  ::efl::gfx::Hint const ,  ::efl::gfx::Mapping const ,  ::efl::gfx::Stack const ,  ::efl::input::Interface const > operator&() const { return {this}; }
    /// @endcond
    ::efl::eo::wref<Event_Grabber> _get_wref() const { return ::efl::eo::wref<Event_Grabber>(*this); }
    ...
    const Event_Grabber* operator->() const { return this; }
    Event_Grabber* operator->() { return this; }
    operator Eo*() const { return _eo_ptr(); }
#endif 
    friend bool operator==(Event_Grabber const& lhs, Event_Grabber const& rhs)
    { return lhs._get_concrete() == rhs._get_concrete(); }
    friend bool operator!=(Event_Grabber const& lhs, Event_Grabber const& rhs)
    { return !(lhs == rhs); }
};
static_assert(sizeof(Event_Grabber) == sizeof(Eo*), "");
static_assert(std::is_standard_layout<Event_Grabber>::value, "");
} } 
