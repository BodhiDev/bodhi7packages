#ifndef EFL_CANVAS_SNAPSHOT_EO_HH
#define EFL_CANVAS_SNAPSHOT_EO_HH
#include <Eo.h>
...
#ifndef EFL_CANVAS_SNAPSHOT_FWD_GUARD
#define EFL_CANVAS_SNAPSHOT_FWD_GUARD
namespace efl { namespace canvas { 
struct Snapshot;
} } 
namespace efl { namespace eo { template<> struct is_eolian_object< ::efl::canvas::Snapshot> : ::std::true_type {}; } }
namespace efl { namespace eo { template<> struct is_eolian_object< ::efl::canvas::Snapshot&> : ::std::true_type {}; } }
namespace efl { namespace eo { template<> struct is_eolian_object< ::efl::canvas::Snapshot const> : ::std::true_type {}; } }
namespace efl { namespace eo { template<> struct is_eolian_object< ::efl::canvas::Snapshot const&> : ::std::true_type {}; } }
#endif
...
struct Snapshot {
    ...
    {
        return EFL_CANVAS_SNAPSHOT_CLASS;
    }
    Eo* _eo_ptr() const { return *(reinterpret_cast<Eo **>(const_cast<Snapshot *>(this))); }
    operator ::efl::canvas::Snapshot() const;
    operator ::efl::canvas::Snapshot&();
    operator ::efl::canvas::Snapshot const&() const;
    /// @cond LOCAL
     ::efl::eolian::address_of_operator<Snapshot,  ::efl::File_Save,  ::efl::Loop_Consumer,  ::efl::Object,  ::efl::canvas::Image_Internal,  ::efl::canvas::Object,  ::efl::canvas::Object_Animation,  ::efl::canvas::Pointer,  ::efl::canvas::filter::Internal,  ::efl::gfx::Buffer,  ::efl::gfx::Color,  ::efl::gfx::Entity,  ::efl::gfx::Fill,  ::efl::gfx::Filter,  ::efl::gfx::Hint,  ::efl::gfx::Image,  ::efl::gfx::Image_Orientable,  ::efl::gfx::Mapping,  ::efl::gfx::Stack,  ::efl::gfx::View,  ::efl::input::Interface> operator&() { return {this}; }
     ::efl::eolian::address_of_operator<Snapshot const ,  ::efl::File_Save const ,  ::efl::Loop_Consumer const ,  ::efl::Object const ,  ::efl::canvas::Image_Internal const ,  ::efl::canvas::Object const ,  ::efl::canvas::Object_Animation const ,  ::efl::canvas::Pointer const ,  ::efl::canvas::filter::Internal const ,  ::efl::gfx::Buffer const ,  ::efl::gfx::Color const ,  ::efl::gfx::Entity const ,  ::efl::gfx::Fill const ,  ::efl::gfx::Filter const ,  ::efl::gfx::Hint const ,  ::efl::gfx::Image const ,  ::efl::gfx::Image_Orientable const ,  ::efl::gfx::Mapping const ,  ::efl::gfx::Stack const ,  ::efl::gfx::View const ,  ::efl::input::Interface const > operator&() const { return {this}; }
    /// @endcond
};
} } 
}
namespace efl { namespace canvas { 
struct Snapshot : private ::efl::eo::concrete
...
{
    explicit Snapshot( ::Eo* eo)
        : ::efl::eo::concrete(eo) {}
    Snapshot(std::nullptr_t)
    ...
    Snapshot(Derived&& derived
        , typename std::enable_if<
            ::efl::eo::is_eolian_object<Derived>::value
             && std::is_base_of< Snapshot, Derived>::value>::type* = 0)
            : ::efl::eo::concrete(derived._eo_ptr()) {}

    Snapshot( ::efl::eo::instantiate_t)
    {
        ::efl::eolian::do_eo_add( ::efl::eo::concrete::_eo_raw, ::efl::eo::concrete{nullptr}, _eo_class());
    }
    template <typename T>
    explicit Snapshot( ::efl::eo::instantiate_t, T&& parent, typename std::enable_if< ::efl::eo::is_eolian_object<T>::value>::type* = 0)
    {
        ::efl::eolian::do_eo_add( ::efl::eo::concrete::_eo_raw, parent, _eo_class());
    }
    template <typename F> Snapshot( ::efl::eo::instantiate_t, F&& f, typename ::std::enable_if< ::efl::eolian::is_constructor_lambda<F, Snapshot >::value>::type* = 0)
    {
        ::efl::eolian::do_eo_add( ::efl::eo::concrete::_eo_raw, ::efl::eo::concrete{nullptr}, _eo_class(), *this, std::forward<F>(f));
    }
    template <typename T, typename F> Snapshot(  ::efl::eo::instantiate_t, T&& parent, F&& f, typename ::std::enable_if< ::efl::eolian::is_constructor_lambda<F, Snapshot >::value && ::efl::eo::is_eolian_object<T>::value>::type* = 0)
    {
    ...
    /// @cond LOCAL
     ...
     ::efl::eolian::address_of_operator<Snapshot const ,  ::efl::File_Save const ,  ::efl::Loop_Consumer const ,  ::efl::Object const ,  ::efl::canvas::Image_Internal const ,  ::efl::canvas::Object const ,  ::efl::canvas::Object_Animation const ,  ::efl::canvas::Pointer const ,  ::efl::canvas::filter::Internal const ,  ::efl::gfx::Buffer const ,  ::efl::gfx::Color const ,  ::efl::gfx::Entity const ,  ::efl::gfx::Fill const ,  ::efl::gfx::Filter const ,  ::efl::gfx::Hint const ,  ::efl::gfx::Image const ,  ::efl::gfx::Image_Orientable const ,  ::efl::gfx::Mapping const ,  ::efl::gfx::Stack const ,  ::efl::gfx::View const ,  ::efl::input::Interface const > operator&() const { return {this}; }
    /// @endcond
    ::efl::eo::wref<Snapshot> _get_wref() const { return ::efl::eo::wref<Snapshot>(*this); }
    ...
    const Snapshot* operator->() const { return this; }
    Snapshot* operator->() { return this; }
    operator Eo*() const { return _eo_ptr(); }
#endif 
    friend bool operator==(Snapshot const& lhs, Snapshot const& rhs)
    { return lhs._get_concrete() == rhs._get_concrete(); }
    friend bool operator!=(Snapshot const& lhs, Snapshot const& rhs)
    { return !(lhs == rhs); }
};
static_assert(sizeof(Snapshot) == sizeof(Eo*), "");
