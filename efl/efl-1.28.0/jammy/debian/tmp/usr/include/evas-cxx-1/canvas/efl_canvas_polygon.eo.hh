#ifndef EFL_CANVAS_POLYGON_EO_HH
#define EFL_CANVAS_POLYGON_EO_HH
#include <Eo.h>
...
#include "efl_canvas_polygon.eo.h"
...
#ifndef EFL_CANVAS_POLYGON_FWD_GUARD
#define EFL_CANVAS_POLYGON_FWD_GUARD
namespace efl { namespace canvas { 
struct Polygon;
} } 
namespace efl { namespace eo { template<> struct is_eolian_object< ::efl::canvas::Polygon> : ::std::true_type {}; } }
namespace efl { namespace eo { template<> struct is_eolian_object< ::efl::canvas::Polygon&> : ::std::true_type {}; } }
namespace efl { namespace eo { template<> struct is_eolian_object< ::efl::canvas::Polygon const> : ::std::true_type {}; } }
namespace efl { namespace eo { template<> struct is_eolian_object< ::efl::canvas::Polygon const&> : ::std::true_type {}; } }
#endif
...
struct Polygon {
    ...
    ::efl::eolian::return_traits<void>::type point_add( ::efl::eolian::in_traits<Eina_Position2D>::type pos) const;
#endif
#ifdef EFL_BETA_API_SUPPORT
    ::efl::eolian::return_traits<void>::type points_clear() const;
#endif
    static Efl_Class const* _eo_class()
    {
        return EFL_CANVAS_POLYGON_CLASS;
    }
    Eo* _eo_ptr() const { return *(reinterpret_cast<Eo **>(const_cast<Polygon *>(this))); }
    operator ::efl::canvas::Polygon() const;
    operator ::efl::canvas::Polygon&();
    operator ::efl::canvas::Polygon const&() const;
    /// @cond LOCAL
     ::efl::eolian::address_of_operator<Polygon,  ::efl::Loop_Consumer,  ::efl::Object,  ::efl::canvas::Object,  ::efl::canvas::Object_Animation,  ::efl::canvas::Pointer,  ::efl::gfx::Color,  ::efl::gfx::Entity,  ::efl::gfx::Hint,  ::efl::gfx::Mapping,  ::efl::gfx::Stack,  ::efl::input::Interface> operator&() { return {this}; }
     ::efl::eolian::address_of_operator<Polygon const ,  ::efl::Loop_Consumer const ,  ::efl::Object const ,  ::efl::canvas::Object const ,  ::efl::canvas::Object_Animation const ,  ::efl::canvas::Pointer const ,  ::efl::gfx::Color const ,  ::efl::gfx::Entity const ,  ::efl::gfx::Hint const ,  ::efl::gfx::Mapping const ,  ::efl::gfx::Stack const ,  ::efl::input::Interface const > operator&() const { return {this}; }
    /// @endcond
};
} } 
}
namespace efl { namespace canvas { 
struct Polygon : private ::efl::eo::concrete
    ...
    , EO_CXX_INHERIT(::efl::input::Interface)
{
    ...
    Polygon(Derived&& derived
        , typename std::enable_if<
            ::efl::eo::is_eolian_object<Derived>::value
             && std::is_base_of< Polygon, Derived>::value>::type* = 0)
            : ::efl::eo::concrete(derived._eo_ptr()) {}

    Polygon( ::efl::eo::instantiate_t)
    {
        ::efl::eolian::do_eo_add( ::efl::eo::concrete::_eo_raw, ::efl::eo::concrete{nullptr}, _eo_class());
    }
    template <typename T>
    explicit Polygon( ::efl::eo::instantiate_t, T&& parent, typename std::enable_if< ::efl::eo::is_eolian_object<T>::value>::type* = 0)
    {
        ::efl::eolian::do_eo_add( ::efl::eo::concrete::_eo_raw, parent, _eo_class());
    }
    template <typename F> Polygon( ::efl::eo::instantiate_t, F&& f, typename ::std::enable_if< ::efl::eolian::is_constructor_lambda<F, Polygon >::value>::type* = 0)
    {
        ::efl::eolian::do_eo_add( ::efl::eo::concrete::_eo_raw, ::efl::eo::concrete{nullptr}, _eo_class(), *this, std::forward<F>(f));
    }
    template <typename T, typename F> Polygon(  ::efl::eo::instantiate_t, T&& parent, F&& f, typename ::std::enable_if< ::efl::eolian::is_constructor_lambda<F, Polygon >::value && ::efl::eo::is_eolian_object<T>::value>::type* = 0)
    {
    ...
    /// @cond LOCAL
     ...
     ::efl::eolian::address_of_operator<Polygon const ,  ::efl::Loop_Consumer const ,  ::efl::Object const ,  ::efl::canvas::Object const ,  ::efl::canvas::Object_Animation const ,  ::efl::canvas::Pointer const ,  ::efl::gfx::Color const ,  ::efl::gfx::Entity const ,  ::efl::gfx::Hint const ,  ::efl::gfx::Mapping const ,  ::efl::gfx::Stack const ,  ::efl::input::Interface const > operator&() const { return {this}; }
    /// @endcond
    ::efl::eo::wref<Polygon> _get_wref() const { return ::efl::eo::wref<Polygon>(*this); }
    ...
    const Polygon* operator->() const { return this; }
    Polygon* operator->() { return this; }
...
static_assert(sizeof(Polygon) == sizeof(Eo*), "");
static_assert(std::is_standard_layout<Polygon>::value, "");
} } 
