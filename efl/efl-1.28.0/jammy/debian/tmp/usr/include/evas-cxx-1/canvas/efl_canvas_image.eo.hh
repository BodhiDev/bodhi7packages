#ifndef EFL_CANVAS_IMAGE_EO_HH
#define EFL_CANVAS_IMAGE_EO_HH
#include <Eo.h>
...
#ifndef EFL_CANVAS_IMAGE_FWD_GUARD
#define EFL_CANVAS_IMAGE_FWD_GUARD
namespace efl { namespace canvas { 
struct Image;
} } 
namespace efl { namespace eo { template<> struct is_eolian_object< ::efl::canvas::Image> : ::std::true_type {}; } }
namespace efl { namespace eo { template<> struct is_eolian_object< ::efl::canvas::Image&> : ::std::true_type {}; } }
namespace efl { namespace eo { template<> struct is_eolian_object< ::efl::canvas::Image const> : ::std::true_type {}; } }
namespace efl { namespace eo { template<> struct is_eolian_object< ::efl::canvas::Image const&> : ::std::true_type {}; } }
#endif
...
struct Image {
    ...
    {
        return EFL_CANVAS_IMAGE_CLASS;
    }
    Eo* _eo_ptr() const { return *(reinterpret_cast<Eo **>(const_cast<Image *>(this))); }
    operator ::efl::canvas::Image() const;
    operator ::efl::canvas::Image&();
    operator ::efl::canvas::Image const&() const;
    /// @cond LOCAL
     ::efl::eolian::address_of_operator<Image,  ::efl::File,  ::efl::File_Save,  ::efl::Loop_Consumer,  ::efl::Object,  ::efl::canvas::Image_Internal,  ::efl::canvas::Object,  ::efl::canvas::Object_Animation,  ::efl::canvas::Pointer,  ::efl::canvas::filter::Internal,  ::efl::gfx::Buffer,  ::efl::gfx::Color,  ::efl::gfx::Entity,  ::efl::gfx::Fill,  ::efl::gfx::Filter,  ::efl::gfx::Frame_Controller,  ::efl::gfx::Hint,  ::efl::gfx::Image,  ::efl::gfx::Image_Load_Controller,  ::efl::gfx::Image_Orientable,  ::efl::gfx::Mapping,  ::efl::gfx::Stack,  ::efl::gfx::View,  ::efl::input::Interface> operator&() { return {this}; }
     ::efl::eolian::address_of_operator<Image const ,  ::efl::File const ,  ::efl::File_Save const ,  ::efl::Loop_Consumer const ,  ::efl::Object const ,  ::efl::canvas::Image_Internal const ,  ::efl::canvas::Object const ,  ::efl::canvas::Object_Animation const ,  ::efl::canvas::Pointer const ,  ::efl::canvas::filter::Internal const ,  ::efl::gfx::Buffer const ,  ::efl::gfx::Color const ,  ::efl::gfx::Entity const ,  ::efl::gfx::Fill const ,  ::efl::gfx::Filter const ,  ::efl::gfx::Frame_Controller const ,  ::efl::gfx::Hint const ,  ::efl::gfx::Image const ,  ::efl::gfx::Image_Load_Controller const ,  ::efl::gfx::Image_Orientable const ,  ::efl::gfx::Mapping const ,  ::efl::gfx::Stack const ,  ::efl::gfx::View const ,  ::efl::input::Interface const > operator&() const { return {this}; }
    /// @endcond
};
} } 
}
